 ...
 */
public class SDataCommissionsSalesAgentType extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataCommissionsSalesAgentType() {
        super(SDataConstants.MKT_COMMS_SAL_AGT_TP);
    ...
    public void setDbmsSalesAgentType(java.lang.String s) { msDbmsSalesAgentType = s; }
    ...
    private java.lang.String query(java.lang.Object params){
        ...
        sql = "SELECT tp.tp_sal_agt, cm.*, " +
                ...
                "WHERE cm.id_tp_sal_agt = " + ((Integer) key[0]) + " AND cm.id_tp_link = " + ((Integer) key[1]) + " AND cm.id_ref = " + ((Integer) key[2]) +
                " AND cm.id_dt_start = '" + ((String) key[3])  + "' " +
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall(
                    ...
                    "?, ?, ?, ?, ?, " +
                    "?, ?, ?, ?, ?) }");
            callableStatement.setInt(nParam++, mnPkSalesAgentTypeId);
