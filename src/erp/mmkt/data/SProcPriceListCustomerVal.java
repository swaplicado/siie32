 ...
 */
public class SProcPriceListCustomerVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcPriceListCustomerVal() {
        super(SProcConstants.MKT_PLIST_CUS_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL mkt_plist_cus_val(?, ?, ?) }");
