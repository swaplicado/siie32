 ...
 */
public class SDataCommissionsSalesAgent extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataCommissionsSalesAgent() {
        super(SDataConstants.MKT_COMMS_SAL_AGT);
    ...
    private java.lang.String query(java.lang.Object params){
        ...
        sql = "SELECT b.bp, cm.*, " +
                ...
                "WHERE cm.id_sal_agt = " + ((Integer) key[0]) + " AND cm.id_tp_link = " + ((Integer) key[1]) + " AND cm.id_ref = " + ((Integer) key[2]) + " AND cm.id_dt_start = '" + ((String) key[3])  + "' " +
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            ...
            if (!resultSet.next()) {
                ...
                msDbmsSalesAgent = resultSet.getString("b.bp");
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            ...
            callableStatement.setDouble(nParam++, mdAgentPercentage);
            callableStatement.setDouble(nParam++, mdAgentValueUnitary);
            callableStatement.setDouble(nParam++, mdAgentValue);
            callableStatement.setDouble(nParam++, mdSupervisorPercentage);
            callableStatement.setDouble(nParam++, mdSupervisorValueUnitary);
            callableStatement.setDouble(nParam++, mdSupervisorValue);
