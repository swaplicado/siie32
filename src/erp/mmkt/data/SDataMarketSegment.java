 ...
 */
public class SDataMarketSegment extends erp.lib.data.SDataRegistry implements java.io.Serializable {

    protected int mnPkMarketSegmentId;
    protected java.lang.String msMarketSegment;
    ...
    public SDataMarketSegment() {
        super(SDataConstants.MKTU_MKT_SEGM);
        reset();
    }

    public void setPkMarketSegmentId(int n) { mnPkMarketSegmentId = n; }
    public void setMarketSegment(java.lang.String s) { msMarketSegment = s; }
    ...
    public java.lang.String getMarketSegment() { return msMarketSegment; }
    ...
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkMarketSegmentId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM mktu_mkt_segm WHERE id_mkt_segm = " + key[0] + " ";
            ...
            if (!resultSet.next()) {
                ...
                msMarketSegment = resultSet.getString("mkt_segm");
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall(
                    "{ CALL mkt_mkt_segm_save(" +
                    "?, ?, ?, ?, ?, " +
                    "?, ?, ?, ?) }");
            callableStatement.setInt(nParam++, mnPkMarketSegmentId);
            callableStatement.setString(nParam++, msMarketSegment);
