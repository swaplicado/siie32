 ...
 */
public class SProcLeadtimeCobGet extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcLeadtimeCobGet() {
        super(SProcConstants.MFG_LTIME_COB_GET); 
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL mfg_ltime_cob_get(?, ?, ?, ?) }");
