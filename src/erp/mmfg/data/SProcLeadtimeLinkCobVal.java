 ...
 */
public class SProcLeadtimeLinkCobVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcLeadtimeLinkCobVal() {
        super(SProcConstants.MFG_LTIME_LINK_COB_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL mfg_ltime_link_cob_val(?, ?, ?, ?, ?) }");
