 ...
 * - erp.mmfg.data.SDataCostClosePeriod
...
public class SDataCost extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    private java.util.Vector<erp.mmfg.data.SDataCost> mvDbmsCost;

    public SDataCost() {
        super(SDataConstants.MFG_COST);

        mvDbmsCost = new Vector<SDataCost>();
    ...
    public void setDbmsType(int n) { mnDbmsType = n; }
    ...
    public int getDbmsType() { return mnDbmsType; }
    ...
    public java.util.Vector<SDataCost> getDbmsCost() { return mvDbmsCost; }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            ...
            if ((Integer)((Object[]) key)[0] == SDataConstants.MFG_COST) {
                ...
                sql = "SELECT bp.bp, " +
                    ...
                    ((Integer)((Object[]) key)[2] == SDataConstantsSys.MFGS_TP_COST_ORD ? "INNER JOIN mfg_ord AS o ON c.id_ref_ref = o.id_year AND c.id_ref_ent = o.id_ord " :
                     (Integer)((Object[]) key)[2] == SDataConstantsSys.MFGS_TP_COST_LINE ? "INNER JOIN mfg_line AS l ON c.id_ref_cob = l.id_cob AND c.id_ref_ref = l.id_ent AND c.id_ref_ent = l.id_line " :
                     (Integer)((Object[]) key)[2] == SDataConstantsSys.MFGS_TP_COST_PLT ? "INNER JOIN erp.cfgu_cob_ent AS e ON c.id_ref_ref = e.id_cob AND c.id_ref_ent = e.id_ent " : "") +
                    "WHERE c.id_bp = " + (Integer)((Object[]) key)[6] + " AND  c.id_dt BETWEEN '" + (java.util.Date)((Object[]) key)[7] + "' AND '" + (java.util.Date)((Object[]) key)[8] + "' AND c.b_del = 0 AND c.b_acc = 0 " +
                    "ORDER BY bp.bp, c.id_year, c.id_tp_cost_obj, c.id_ref_cob, c.id_ref_ref, c.id_ref_ent, c.id_bp, c.id_dt, c.id_tp_hr ";
            }

            mtDbmsDateStart = (java.util.Date)((Object[]) key)[7];
            mtDbmsDateEnd = (java.util.Date)((Object[]) key)[8];
            mnDbmsType =  (Integer)((Object[]) key)[0];
            ...
            if (!resultSet.next()) {
                ...
                while (resultSet.next()) {
                    ...
                    oCost.setDbmsType(mnDbmsType);
                    oCost.setDbmsBizPartner(resultSet.getString("bp.bp"));
                    oCost.setDbmsReference(resultSet.getString("f_cost_obj"));
