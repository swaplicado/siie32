 ...
 */
public class SProcLeadtimeCoVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcLeadtimeCoVal() {
        super(SProcConstants.MFG_LTIME_CO_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL mfg_ltime_co_val(?, ?) }");
