 ...
 */
public class SFormProductionOrderNotes extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener {
    ...
    private erp.mmfg.data.SDataProductionOrderNotes moOrdNotes;
    private erp.lib.form.SFormField moFieldNotes;
    private erp.lib.form.SFormField moFieldIsDeleted;

    /** Creates new form DFormCompany */
    public SFormProductionOrderNotes(erp.client.SClientInterface client) {
        super(client.getFrame(), true);
        miClient = client;
        mnFormType = SDataConstants.MFG_ORD_NTS;
    ...
    public void setRegistry(erp.lib.data.SDataRegistry registry) {
        moOrdNotes = (SDataProductionOrderNotes) registry;

        moFieldNotes.setFieldValue(moOrdNotes.getNotes());
        moFieldIsDeleted.setBoolean(moOrdNotes.getIsDeleted());
    ...
    public erp.lib.data.SDataRegistry getRegistry() {
        if (moOrdNotes == null) {
            moOrdNotes = new SDataProductionOrderNotes();
            moOrdNotes.setFkUserNewId(miClient.getSession().getUser().getPkUserId());
        }
        else
            moOrdNotes.setFkUserEditId(miClient.getSession().getUser().getPkUserId());

        moOrdNotes.setNotes(moFieldNotes.getString());
        moOrdNotes.setIsDeleted(moFieldIsDeleted.getBoolean());
