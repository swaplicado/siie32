 ...
 */
public class SFormAnalysisDpsEty extends sa.lib.gui.bean.SBeanForm implements java.awt.event.ActionListener {

    private int mnFormResult;
    private int mnFormStatus;
    private boolean mbFirstTime;
    private java.util.Vector<erp.lib.form.SFormField> mvFields;
    private erp.client.SClientInterface miInterfaceClient;
    
    public static final int DPS_YEAR = 1;
    public static final int DPS_DOC = 2;
    public static final int DPS_ETY = 3;
    public static final int DPS_ITEM = 4;

    private SDbDpsEntryAnalysis moDataAnalysisItem;
    
    private erp.lib.form.SFormField moFieldOrderPos;
    private erp.lib.form.SFormField moFieldSpecification;
...
//    private erp.lib.form.SFormField moFieldIsDeleted;
    private erp.lib.form.SFormField moFieldFkAnalysisId;
    private erp.lib.form.SFormField moFieldFkItemId;
    
    private int mnFkYearId;
    private int mnFkDocId;
    private int mnFkEtyId;

    public SFormAnalysisDpsEty(erp.client.SClientInterface client, String title) {
        miInterfaceClient = client;
    ...
    private void initComponents() {
        ...
        jlSpecification.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel10.add(jlSpecification);

        moTextSpecification.setPreferredSize(new java.awt.Dimension(300, 23));
        jPanel10.add(moTextSpecification);
    ...
    private void initComponentsExtra() {
        ...
        moFieldOrderPos = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_INTEGER, true, jtfOrderPosition, jlOrderPos);
        moFieldSpecification = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_STRING, true, moTextSpecification, jlSpecification);
        moFieldSpecification.setLengthMax(150);
        moFieldIsMax = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_BOOLEAN, true, jckIsMax);
        moFieldMaxValue = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_STRING, false, jtfMaxValue, jlMaxValue);
        moFieldIsMin = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_BOOLEAN, true, jckIsMin);
        moFieldMinValue = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_STRING, false, jtfMinValue, jlMinValue);
        moFieldIsRequired = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_BOOLEAN, true, jckIsRequired);
//        moFieldIsDeleted = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_BOOLEAN, true, jckIsDeleted);
        moFieldFkAnalysisId = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_KEY, true, jcbPkAnalysisId, jlPkAnalysisId);
        moFieldFkAnalysisId.setPickerButton(jbPkAnalysisId);
        moFieldFkItemId = new SFormField(miInterfaceClient, SLibConstants.DATA_TYPE_KEY, true, jcbFkItemId, jlPkItemId);
...
//        mvFields.add(moFieldIsDeleted);
        mvFields.add(moFieldFkAnalysisId);
    ...
    private void actionPkAnalysisId() {
        miInterfaceClient.pickOption(SDataConstants.QLT_ANALYSIS, moFieldFkAnalysisId, new int[] { moFieldFkAnalysisId.getKeyAsIntArray()[0] });
    }
    
    private void actionPkItemId() {
        miInterfaceClient.pickOption(SDataConstants.ITMU_ITEM, moFieldFkItemId, new int[] { moFieldFkItemId.getKeyAsIntArray()[0] });
    }
    ...
    private void actionOk() {
        ...
        if (validation.getIsError()) {
            ...
            if (validation.getMessage().length() > 0) {
                miInterfaceClient.showMsgBoxWarning(validation.getMessage());
            }
        }
        else {
    ...
    public void formReset() {
        ...
        SFormUtilities.populateComboBox(miInterfaceClient, jcbFkItemId, SDataConstants.ITMU_ITEM);
        SFormUtilities.populateComboBox(miInterfaceClient, jcbPkAnalysisId, SDataConstants.QLT_ANALYSIS);
        
        moFieldFkAnalysisId.getComponent().requestFocus();
    }
    ...
    public void setValue(int type, java.lang.Object value) {
        switch (type) {
            case DPS_YEAR:
                mnFkYearId = (Integer) value;
                break;
            case DPS_DOC:
                mnFkDocId = (Integer) value;
                break;
            case DPS_ETY:
                mnFkEtyId = (Integer) value;
                break;
            case DPS_ITEM:
                moFieldFkItemId.setKey(new int[] { (Integer) value });
                jcbFkItemId.setEnabled(false);
                break;
            default:
                miClient.showMsgBoxError("El tipo de valor no es válido.");
                break;
        }
    }
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moDataAnalysisItem = (SDbDpsEntryAnalysis) registry;
        
        moFieldOrderPos.setFieldValue(moDataAnalysisItem.getSortPos());
        moFieldSpecification.setFieldValue(moDataAnalysisItem.getSpecification());
        moFieldIsMax.setFieldValue(moDataAnalysisItem.isMax());
        moFieldMaxValue.setFieldValue(moDataAnalysisItem.getMaxValue());
        moFieldIsMin.setFieldValue(moDataAnalysisItem.isMin());
        moFieldMinValue.setFieldValue(moDataAnalysisItem.getMinValue());
        moFieldIsRequired.setFieldValue(moDataAnalysisItem.isRequired());
//        moFieldIsDeleted.setFieldValue(moDataAnalysisItem.isDeleted());
        moFieldFkAnalysisId.setKey(new int[] { moDataAnalysisItem.getFkAnalysisId() });
        moFieldFkItemId.setKey(new int[] { moDataAnalysisItem.getFkItemId() });

        this.enabledFields(moDataAnalysisItem.isRegistryNew());
    }

    @Override
    public SDbRegistry getRegistry() throws Exception {
        if (moDataAnalysisItem == null) {
            moDataAnalysisItem = new SDbDpsEntryAnalysis();

//            moDataAnalysisItem.setIsDeleted(moFieldIsDeleted.getBoolean());
            moDataAnalysisItem.setFkUserNewId(miInterfaceClient.getSession().getUser().getPkUserId());
            moDataAnalysisItem.setUserNewTs(miInterfaceClient.getSessionXXX().getWorkingDate());
            moDataAnalysisItem.setFkUserEditId(SUtilConsts.USR_NA_ID);
            moDataAnalysisItem.setUserEditTs(miInterfaceClient.getSessionXXX().getWorkingDate());
            moDataAnalysisItem.setFkUserDeleteId(SUtilConsts.USR_NA_ID);
            moDataAnalysisItem.setUserDeleteTs(miInterfaceClient.getSessionXXX().getWorkingDate());
        }
        else {
//            moDataAnalysisItem.setIsDeleted(moFieldIsDeleted.getBoolean());
            moDataAnalysisItem.setFkUserEditId(miInterfaceClient.getSession().getUser().getPkUserId());
            moDataAnalysisItem.setUserEditTs(miInterfaceClient.getSessionXXX().getWorkingDate());

//            if (moFieldIsDeleted.getBoolean()) {
//                moDataAnalysisItem.setFkUserDeleteId(miInterfaceClient.getSession().getUser().getPkUserId());
//                moDataAnalysisItem.setUserDeleteTs(miInterfaceClient.getSessionXXX().getWorkingDate());
//            }
//            else {
                moDataAnalysisItem.setFkUserDeleteId(SUtilConsts.USR_NA_ID);
//            }
        ...
        moDataAnalysisItem.setSortPos(moFieldOrderPos.getInteger());
        moDataAnalysisItem.setSpecification(moFieldSpecification.getString());
        ...
        moDataAnalysisItem.setRequired(moFieldIsRequired.getBoolean());
        moDataAnalysisItem.setFkDpsYearId(mnFkYearId);
        moDataAnalysisItem.setFkDpsDocId(mnFkDocId);
        moDataAnalysisItem.setFkDpsEntryId(mnFkEtyId);
        moDataAnalysisItem.setFkAnalysisId(moFieldFkAnalysisId.getKeyAsIntArray()[0]);
        moDataAnalysisItem.setFkItemId(moFieldFkItemId.getKeyAsIntArray()[0]);
