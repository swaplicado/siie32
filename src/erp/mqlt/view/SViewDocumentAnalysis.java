...
public class SViewDocumentAnalysis extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT  "
                ...
                + "        INNER JOIN "
                + "     " + SDataConstants.TablesMap.get(SDataConstants.TRN_DPS_ETY_ANALYSIS) + " AS dea ON de.id_year = dea.fid_dps_year "
                + "        AND de.id_doc = dea.fid_dps_doc "
                + "        AND de.id_ety = dea.fid_dps_ety "
                + "        INNER JOIN "
