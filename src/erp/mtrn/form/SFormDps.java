...
public class SFormDps extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener, java.awt.event.FocusListener, java.awt.event.ItemListener, erp.lib.form.SFormExtendedInterface {
    ...
    private static final int TAB_CFD = 3;   // CFD
    private static final int TAB_INT = 4;   // CFD International Commerce
    ...
    private void initComponents() {
        ...
        jlCfdCceNumberImportRequest = new javax.swing.JLabel();
        jcbCfdCceNumberImportRequest = new javax.swing.JComboBox<SFormComponentItem>();
        ...
        jpInternationalTrade.setLayout(new java.awt.BorderLayout());

        jPanel107.setLayout(new java.awt.GridLayout(1, 2));

        jPanel105.setLayout(new java.awt.GridLayout(1, 2));

        jPanel97.setLayout(new java.awt.GridLayout(10, 1, 0, 2));
        ...
        jlFkIncotermId.setPreferredSize(new java.awt.Dimension(150, 23));
        ...
        jlFkSpotDesId_n.setPreferredSize(new java.awt.Dimension(150, 23));
        ...
        jlCfdCceReasonTransfer.setText("Motivo de traslado:");
        jlCfdCceReasonTransfer.setPreferredSize(new java.awt.Dimension(150, 23));
        jPanel98.add(jlCfdCceReasonTransfer);

        jcbCfdCceReasonTransfer.setPreferredSize(new java.awt.Dimension(200, 23));
        jPanel98.add(jcbCfdCceReasonTransfer);
        ...
        jcbCfdCceOperationType.setPreferredSize(new java.awt.Dimension(200, 23));
        ...
        jcbCfdCceNumberImportRequest.setPreferredSize(new java.awt.Dimension(200, 23));
        jPanel100.add(jcbCfdCceNumberImportRequest);
        ...
        jtfCfdCceCertificateOrigin.setPreferredSize(new java.awt.Dimension(125, 23));
        ...
        jtfCfdCceNumberCertificateOrigin.setPreferredSize(new java.awt.Dimension(125, 23));
        ...
        jtfCfdCceSubdivision.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel108.add(jtfCfdCceSubdivision);

        jPanel97.add(jPanel108);

        jPanel106.setPreferredSize(new java.awt.Dimension(23, 23));
        jPanel106.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 2, 0));
        jPanel97.add(jPanel106);

        jPanel105.add(jPanel97);

        jPanel96.setLayout(new java.awt.GridLayout(10, 1, 0, 2));
        ...
        jPanel105.add(jPanel96);

        jPanel107.add(jPanel105);

        jpInternationalTrade.add(jPanel107, java.awt.BorderLayout.NORTH);

        jTabbedPane.addTab("Comercio exterior", jpInternationalTrade);
    ...
    private void initComponentsExtra() {
        ...
        moFieldFolioNotaRecepcion.setTabbedPaneIndex(TAB_CFD, jTabbedPane);
        ...
        moFieldBachocoSociedad.setTabbedPaneIndex(TAB_CFD, jTabbedPane);
        ...
        moFieldBachocoOrganizacionCompra.setTabbedPaneIndex(TAB_CFD, jTabbedPane);
        ...
        moFieldBachocoDivision.setTabbedPaneIndex(TAB_CFD, jTabbedPane);
        ...
        moFieldDpsDescripcion.setTabbedPaneIndex(TAB_CFD, jTabbedPane);
        ...
        moFieldFkIncotermId.setTabbedPaneIndex(TAB_INT, jTabbedPane);
        ...
        moFieldFkSpotSrcId_n.setTabbedPaneIndex(TAB_INT, jTabbedPane);
        moFieldFkSpotDesId_n = new SFormField(miClient, SLibConstants.DATA_TYPE_KEY, false, jcbFkSpotDesId_n, jlFkSpotDesId_n);
        moFieldFkSpotDesId_n.setTabbedPaneIndex(TAB_INT, jTabbedPane);
        ...
        mvFields.add(moFieldCfdCceReasonTransfer);
        mvFields.add(moFieldCfdCceOperationType);
        mvFields.add(moFieldCfdCceNumberImportRequest);
    ...
    /**
     * Enables/disables tabs for CFD.
     * Called within method obtainNextNumber().
     */
    private void evaluateAvailabilityCfdTabs() {
        if (moBizPartner == null) {
            jTabbedPane.setEnabledAt(TAB_CFD, false);
            jTabbedPane.setEnabledAt(TAB_INT, false);
            enableCfdAddendaFields(false);
        }
        else {
            boolean enabled = isCfdRequired();
            
            jTabbedPane.setEnabledAt(TAB_CFD, enabled);
            jTabbedPane.setEnabledAt(TAB_INT, enabled && !moBizPartner.isDomestic(miClient));
            enableCfdAddendaFields(enabled);
        }
    }
    ...
    /**
     * Enables/disables fields for CFD international trade data.
     * @param enable Desired status for fields.
     */
    private void enableCfdCceFields(boolean enable) {
        jcbCfdCceReasonTransfer.setEnabled(enable);
        jcbCfdCceOperationType.setEnabled(enable);
        jcbCfdCceNumberImportRequest.setEnabled(enable);
        jtfCfdCceCertificateOrigin.setEditable(enable);
        jtfCfdCceCertificateOrigin.setFocusable(enable);
        jtfCfdCceNumberCertificateOrigin.setEditable(enable);
        jtfCfdCceNumberCertificateOrigin.setFocusable(enable);
        jtfCfdCceSubdivision.setEditable(enable);
        jtfCfdCceSubdivision.setFocusable(enable);
        jtfCfdCceExchangeRateUSD.setEditable(enable);
        jtfCfdCceExchangeRateUSD.setFocusable(enable);
        jtfCfdCceTotalUSD.setEditable(enable);
        jtfCfdCceTotalUSD.setFocusable(enable);
    }
    
    /**
     * XXX Refactor this method! (20174-02-23, sflores)
     * @param enable 
     */
    ...
    /**
     * Checks if CFD is required for current document.
     * @return <code>true</code> if CFD is required.
     */
    private boolean isCfdRequired() {
        boolean isDocSuitable = mbIsSales && (mbIsDoc || mbIsAdj);
        boolean isXmlSuitable = miClient.getSessionXXX().getParamsCompany().getFkXmlTypeId() != SDataConstantsSys.TRNS_TP_XML_NA;
    ...
    private void obtainNextNumber() {
        ...
        // enable/disable CFD form tabs:
        
        evaluateAvailabilityCfdTabs();
    }
    ...
    private void updateFormEditStatus(boolean enable) {
        if (!enable) {
            ...
            enableCfdFields(isCfdRequired());
            enableCfdCceFields(isCfdRequired() && !moBizPartner.isDomestic(miClient));
        }

        if (jTabbedPane.isEnabledAt(3)) {
            enableCfdAddendaFields(true);
        }
    }
    ...
    private void setDpsType(int[] keyDocType) {
        ...
        if (!isNumberSeriesBySystem()) {
            ...
            // get available number series from current company branch configuration:
        ...
        jcbDriver.removeAllItems(); // XXX improve this! (2017-02-23, sflores)
        jcbPlate.removeAllItems();  // XXX improve this! (2017-02-23, sflores)
    ...
    private erp.mtrn.data.SCfdParams createCfdParams() {
        ...
        params.setAgregarAddenda(miClient.getSessionXXX().getParamsCompany().getFkXmlTypeId() == SDataConstantsSys.TRNS_TP_XML_CFD);
...
//            moFieldExchangeRateSystem.setFieldValue(rate);
    ...
    private javax.swing.JComboBox<SFormComponentItem> jcbCfdCceNumberImportRequest;
    private javax.swing.JComboBox<SFormComponentItem> jcbCfdCceOperationType;
    private javax.swing.JComboBox<SFormComponentItem> jcbCfdCceReasonTransfer;
    ...
    private javax.swing.JLabel jlCfdCceNumberImportRequest;
    private javax.swing.JLabel jlCfdCceOperationType;
    private javax.swing.JLabel jlCfdCceReasonTransfer;
        ...
        if (!validation.getIsError()) {
            ...
            if (msg.length() > 0) {
                ...
                if (!validation.getIsError()) {
                    ...
                    else if (isCfdRequired() && moPaneGridEntries.getTableGuiRowCount() == 0) {
            ...
            if (!validation.getIsError()) {
                if (isCfdRequired() && moBizPartnerCategory.getFkCfdAddendaTypeId() != SDataConstantsSys.BPSS_TP_CFD_ADD_NA) {
                    switch (moBizPartnerCategory.getFkCfdAddendaTypeId()) {
                        case SDataConstantsSys.BPSS_TP_CFD_ADD_SORIANA:
    ...
    public void setRegistry(erp.lib.data.SDataRegistry registry) {
        ...
        try {
            moFieldCfdCceReasonTransfer.setFieldValue(SCatalogXmlUtils.getNameEntry((SGuiClient) miClient, SDataConstantsSys.TRNS_CFD_CAT_CFD_USE, moDps.getDate(), moDps.getXtaCfdCceReasonTransfer()));
            moFieldCfdCceOperationType.setFieldValue(SCatalogXmlUtils.getNameEntry((SGuiClient) miClient, SDataConstantsSys.TRNS_CFD_CAT_CFD_USE, moDps.getDate(), moDps.getXtaCfdCceOperationType()));
            moFieldCfdCceNumberImportRequest.setFieldValue(SCatalogXmlUtils.getNameEntry((SGuiClient) miClient, SDataConstantsSys.TRNS_CFD_CAT_CFD_USE, moDps.getDate(), moDps.getXtaCfdCceNumberImportRequest()));
    ...
    public erp.lib.data.SDataRegistry getRegistry() {
        ...
        */
        ...
        moDps.setXtaCfdUseCfdi((String) moFieldFkCfdUseId.getKey());
        ...
        if (jcbCfdCceReasonTransfer.isEnabled()) { 
            moDps.setXtaCfdCceReasonTransfer((String) moFieldCfdCceReasonTransfer.getKey());
            moDps.setXtaCfdCceOperationType((String) moFieldCfdCceOperationType.getKey());
            moDps.setXtaCfdCceNumberImportRequest((String) moFieldCfdCceNumberImportRequest.getKey());
            ...
            moDps.setXtaCfdCceTotalUSD(moFieldCfdCceTotalUSD.getDouble());
        }
