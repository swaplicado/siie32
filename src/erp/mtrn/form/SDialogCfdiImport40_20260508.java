 ...
 */
public class SDialogCfdiImport40_20260508 extends javax.swing.JDialog implements java.awt.event.ActionListener, javax.swing.event.ListSelectionListener, javax.swing.event.CellEditorListener {
    ...
    private SDialogCfdiConceptsLinker40 moDialogCfdiPurchaseOrder;
     ...
     * @param documentInfo
     */
    public SDialogCfdiImport40_20260508(erp.client.SClientInterface client, SDataDps purchaseOrder, File cfdiFile, File pdfFile, SDocumentInfo documentInfo) {
    ...
    private void initComponents() {
        ...
        jtfCopyRowInfo.setPreferredSize(new java.awt.Dimension(165, 23));
        ...
        jbPickPurchaseOrderEntries.setText("Elegir partidas de OC");
        jbPickPurchaseOrderEntries.setPreferredSize(new java.awt.Dimension(165, 23));
        jPanel7.add(jbPickPurchaseOrderEntries);

        jlDummy1.setPreferredSize(new java.awt.Dimension(115, 23));
        ...
        jlDummy2.setPreferredSize(new java.awt.Dimension(10, 23));
    ...
    @SuppressWarnings("unchecked")
    private void loadSavedMatchedData(SRowCfdiImport40 rowCfdiImport) { // Carga los datos empatados con anterioridad.
        /*
        ...
        */
        ...
        if (matchId != 0) {
            ...
            rowCfdiImport.setOperationsType(item.getIsPrepayment() ? SDataConstantsSys.TRNX_OPS_TYPE_OPS_PREPAY_INVOICED : SDataConstantsSys.TRNX_OPS_TYPE_OPS_OPS);
    ...
    private void populateTables() {
        ...
        for (int i = 0; i < moComprobante.getEltConceptos().getEltConceptos().size(); i++) {
            SRowCfdiImport40 row = new SRowCfdiImport40(miClient, SDataConstantsSys.TRNX_TP_DPS_DOC, moComprobante.getEltConceptos().getEltConceptos().get(i), i + 1);
            loadSavedMatchedData(row);
        ...
        if (jbPickPurchaseOrderEntries.isEnabled()) {
            ...
            if (selectedRow == -1) {
                ...
                if (moDialogCfdiPurchaseOrder == null) {
                    moDialogCfdiPurchaseOrder = new SDialogCfdiConceptsLinker40(miClient, SDataConstantsSys.TRNX_TP_DPS_DOC);
                }
                
                setDialogCfdiPurchaseOrderCfdiRow(rowCfdiImport);
                moDialogCfdiPurchaseOrder.setFormSettings(formType, null);
                
                if (canShowPurchaseOrderDialog(formType, rowCfdiImport)) {
                    moDialogCfdiPurchaseOrder.setValue(SDialogCfdiConceptsLinker40.VALUE_IN_DPS_ENTRY_DPS_DPS_LINKS, rowCfdiImport.getImportedEntryDpsDpsLinks());
                    ...
                    if (moDialogCfdiPurchaseOrder.getFormResult() == SLibConstants.FORM_RESULT_OK) {
                        ...
                        rowCfdiImport.getImportedEntryDpsDpsLinks().addAll((ArrayList<SDataEntryDpsDpsLink>) moDialogCfdiPurchaseOrder.getValue(SDialogCfdiConceptsLinker40.VALUE_OUT_DPS_ENTRY_DPS_DPS_LINKS)); 
                        rowCfdiImport.setConvFactor((double) moDialogCfdiPurchaseOrder.getValue(SDialogCfdiConceptsLinker40.VALUE_OUT_CONV_FACTOR));
    ...
    private void setDialogCfdiPurchaseOrderCfdiRow(SRowCfdiImport40 rowCfdiImport) {
        ...
        moDialogCfdiPurchaseOrder.setValue(SDialogCfdiConceptsLinker40.VALUE_IN_DPS_TO_LINK_ENTRIES, purchaseOrderEntries);
        moDialogCfdiPurchaseOrder.setValue(SDialogCfdiConceptsLinker40.VALUE_IN_CFDI_ROW, rowCfdiImport);
    }
    ...
    private void setEnabledButtons(final SRowCfdiImport40 rowCfdiImport) { 
        if (rowCfdiImport != null) {
            if (!isWithPurchaseOrder()) {
                ...
                jbSelectOperationsType.setEnabled(rowCfdiImport.getItem() != null); 
            }
