 ...
 */
public class SFormDsmNotes extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener {
    ...
    private erp.mtrn.data.SDataDsmNotes moNotes;
    ...
    public SFormDsmNotes(erp.client.SClientInterface client) {
        super(client.getFrame(), true);
        miClient = client;
        mnFormType = SDataConstants.TRN_DSM_NTS;
    ...
    public void setRegistry(erp.lib.data.SDataRegistry registry) {
        moNotes = (SDataDsmNotes) registry;
