                ...
                if (miClient.getFileChooser().showSaveDialog(miClient.getFrame()) == JFileChooser.APPROVE_OPTION) {
                    ...
                    while (resulSet.next()) {
                        ...
                        */
                        ...
                        buffer += resulSet.getString(1).replace("\"", "'") + ",";
                        buffer += resulSet.getString(2).replace("\"", "'") + ",";
                        buffer += "\"" + resulSet.getString(3).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(4).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(5).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(6).replace("\"", "'") + ", " + resulSet.getString(7).replace("\"", "'") + ", " + resulSet.getString(8).replace("\"", "'") + ", " + resulSet.getString(9).replace("\"", "'") + ", " + resulSet.getString(10).replace("\"", "'") + ", " + resulSet.getString(11).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(12) == null ? ",," : resulSet.getString(12).replace("\"", "'") + ",\"" + resulSet.getString(13).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(14) == null ? ",," : resulSet.getString(14).replace("\"", "'") + ",\"" + resulSet.getString(15).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(16) == null ? ",," : resulSet.getString(16).replace("\"", "'") + ",\"" + resulSet.getString(17).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getDate(18) + "\",";
                        buffer += resulSet.getDate(19) == null ? "," : "\"" + resulSet.getDate(19) + "\",";
                        buffer += "\"" + resulSet.getString(20).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(21).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(47).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getInt(22) + "\",";
                        buffer += "\"" + resulSet.getString(23).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(24).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(25).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(26).replace("\"", "'") + "\",";
                        buffer += resulSet.getDouble(27) - resulSet.getDouble(28) + ",";
                        buffer += "\"" + resulSet.getString(29).replace("\"", "'") + "\",";
                        ...
                        buffer += "\"" + resulSet.getString(36).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(37) == null ? ",," : resulSet.getString(37).replace("\"", "'") + ",\"" + resulSet.getString(38).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(39) == null ? ",," : resulSet.getString(39).replace("\"", "'") + ",\"" + resulSet.getString(40).replace("\"", "'") + "\",";
                        buffer += resulSet.getString(41).replace("\"", "'") + ",";
                        buffer += "\"" + resulSet.getString(42).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(43).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(44).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(45).replace("\"", "'") + "\",";
                        buffer += "\"" + resulSet.getString(46).replace("\"", "'") + "\"";
