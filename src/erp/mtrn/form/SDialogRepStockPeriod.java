...
/*
 * SDialogRepStockPeriod.java
 *
 * Created on 8/09/2017, 16:02:14 PM
 */
 ...
 * @author Claudio Peña
 */
public class SDialogRepStockPeriod extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener {
    ...
    /** Creates new form SDialogRepStockWithStartDate */
    public SDialogRepStockPeriod(erp.client.SClientInterface client) {
    ...
    private void initComponents() {
        ...
        jlDateStart.setText("Fecha de inicio: *");
        ...
        jftDateStart.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jftDateStartActionPerformed(evt);
            }
        });
        jPanel8.add(jftDateStart);
    ...
    private void jftDateStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jftDateStartActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jftDateStartActionPerformed
    ...
    private void actionPrint() {
        ...
        if (validation.getIsError()) {
            ...
            try {
                ...
                map.put("tDtStart", moFieldDateStart.getDate());
                ...
                jasperPrint = SDataUtilities.fillReport(miClient, SDataConstantsSys.REP_TRN_STK_PERIOD, map);
