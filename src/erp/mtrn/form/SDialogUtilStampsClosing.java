...
import erp.mtrn.data.SDataStampsClosing;
 ...
 * @author Juan Barajas
 */
public class SDialogUtilStampsClosing extends javax.swing.JDialog {
    ...
    /** Creates new form SDialogUtilStampsClosing */
    public SDialogUtilStampsClosing(erp.client.SClientInterface client) {
    ...
    private void initComponents() {
        ...
        setTitle("Generación de inventario inicial de timbres");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Parámetros de generación de inventario inicial de timbres:"));
        ...
        jlYear.setText("Ejercicio para el que se genera inventario inicial de timbres: *");
        jlYear.setPreferredSize(new java.awt.Dimension(300, 23));
        jPanel1.add(jlYear);
        ...
        jLabel4.setText("el campo 'Ejercicio para el que se genera inventario inicial de timbres' debe ser 2001.");
        jPanel4.add(jLabel4);
        ...
        if (moFieldYear.validateField()) {
            if (!SDataUtilities.isPeriodOpen(miClient, new int[] { moFieldYear.getInteger(), 1 })) {
                ...
                try {
                    ...
                    sc = new SDataStampsClosing();
                    sc.setPkYearId(moFieldYear.getInteger());
                    sc.setAuxSimpleDateFormat(miClient.getSessionXXX().getFormatters().getDbmsDateFormat());

                    SServerRequest request = new SServerRequest(SServerConstants.REQ_DB_ACTION_SAVE);
                    request.setPacket(sc);
                    ...
                    if (response.getResponseType() != SSrvConsts.RESP_TYPE_OK) {
                        ...
                        if (response.getResultType() != SLibConstants.DB_ACTION_SAVE_OK) {
                            miClient.showMsgBoxWarning("Error al generar inventario inicial de timbres:\n -" + SLibConstants.MSG_ERR_DB_REG_SAVE + ".");
                        }
                        else {
