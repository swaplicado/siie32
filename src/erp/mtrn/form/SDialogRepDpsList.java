...
/**
 *
 * @author Alfonso Flores, Claudio Peña, Edwin Carmona, Sergio Flores, Claudio Peña
 */
public class SDialogRepDpsList extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener {
    ...
    /** Creates new form SDialogRepDpsList
     * @param client GUI client.
     */
    public SDialogRepDpsList(erp.client.SClientInterface client) {
    ...
    private void initComponents() {
        ...
        jcbShift = new javax.swing.JComboBox<>();
        ...
        jPanel7.setLayout(new java.awt.GridLayout(5, 1, 0, 1));
        ...
        jcbBizPartner.setPreferredSize(new java.awt.Dimension(225, 23));
        ...
        jPanel12.add(jlBizPartner1);

        jtfFunctionalArea.setEditable(false);
        jtfFunctionalArea.setPreferredSize(new java.awt.Dimension(225, 23));
        jPanel12.add(jtfFunctionalArea);
    ...
    private void actionPrint() {
        ...
        if (validation.getIsError()) {
            ...
            try {
                ...
                jasperViewer.setTitle("Listado de facturas de " + (mbParamIsSupplier ? "proveedores" : "clientes"));
