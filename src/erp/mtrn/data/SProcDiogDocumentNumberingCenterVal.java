 ...
 */
public class SProcDiogDocumentNumberingCenterVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDiogDocumentNumberingCenterVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_dnc_diog_val(?, ?, ?) }");
