 ...
 */
public class SProcDpsDocumentNumberSerieVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDpsDocumentNumberSerieVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_dns_dps_val(?, ?, ?, ?, ?, ?) }");
