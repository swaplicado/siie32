 ...
 */
public class SDataDiogDncCompanyBranch extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataDiogDncCompanyBranch() {
        super(SDataConstants.TRN_DNC_DIOG_COB);
        reset();
    }
    ...
    public void setPrimaryKey(java.lang.Object pk) {
        ...
        mnPkDocNumberingCenterId = ((int[]) pk)[1];
    }

    @Override
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkCompanyBranchId, mnPkDocNumberingCenterId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dnc_diog_cob WHERE id_cob = " + key[0] + " AND id_dnc = " + key[1] + " ";
