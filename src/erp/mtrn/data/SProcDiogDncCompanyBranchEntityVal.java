 ...
 */
public class SProcDiogDncCompanyBranchEntityVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDiogDncCompanyBranchEntityVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_dnc_diog_cob_ent_val(?, ?, ?) }");
