 ...
 */
public class SProcDiogDncDocumentNumberSeriesVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDiogDncDocumentNumberSeriesVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_dnc_diog_dns_val(?, ?, ?) }");
