...
//    }
    ...
    public static void createReportOrder(final SClientInterface client, final File file, final SDataDps dps, final int pnPrintMode, final String dbName) {
        ...
        try {
            ...
            isPending = isPurchase && (dps.getFkDpsAuthorizationStatusId() == SDataConstantsSys.TRNS_ST_DPS_AUTHORN_PENDING || dps.getFkDpsAuthorizationStatusId() == SDataConstantsSys.TRNS_ST_DPS_AUTHORN_NA);
