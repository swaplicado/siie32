 ...
 */
public class SProcGetQuantityDelivered extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetQuantityDelivered() {
        super(SProcConstants.TRN_GET_QTY_DVRD);
    }
