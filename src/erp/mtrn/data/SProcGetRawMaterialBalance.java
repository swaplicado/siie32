 ...
 */
public class SProcGetRawMaterialBalance extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetRawMaterialBalance() {
        super(SProcConstants.TRN_GET_RM_BAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_get_rm_balance(?, ?, ?, ?, ?) }");
