 ...
 */
public class SDataDiogDocumentNumberingCenter extends erp.lib.data.SDataRegistry implements java.io.Serializable {

    protected int mnPkDocNumberingCenterId;
    protected java.lang.String msDocNumberingCenter;
    ...
    public SDataDiogDocumentNumberingCenter() {
        super(SDataConstants.TRN_DNC_DIOG);
        reset();
    }

    public void setPkDocNumberingCenterId(int n) { mnPkDocNumberingCenterId = n; }
    public void setDocNumberingCenter(java.lang.String s) { msDocNumberingCenter = s; }
    ...
    public java.lang.String getDocNumberingCenter() { return msDocNumberingCenter; }
    ...
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkDocNumberingCenterId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dnc_diog WHERE id_dnc = " + key[0] + " ";
            ...
            if (!resultSet.next()) {
                ...
                msDocNumberingCenter = resultSet.getString("dnc");
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall(
                    "{ CALL trn_dnc_diog_save(" +
                    "?, ?, ?, ?, ?, ?, ?, ?, ?) }");
            callableStatement.setInt(nParam++, mnPkDocNumberingCenterId);
            callableStatement.setString(nParam++, msDocNumberingCenter);
            ...
            mnPkDocNumberingCenterId = callableStatement.getInt(nParam - 3);
