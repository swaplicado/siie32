 ...
 * @author Juan Barajas
 */
public class SProcDiogUpdate extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDiogUpdate() {
        super(SProcConstants.TRN_DIOG_UPD);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_diog_upd(?, ?, ?, ?, ?, ?, ?) }");
