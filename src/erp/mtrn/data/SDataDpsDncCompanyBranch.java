 ...
 */
public class SDataDpsDncCompanyBranch extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataDpsDncCompanyBranch() {
        super(SDataConstants.TRN_DNC_DPS_COB);
        reset();
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dnc_dps_cob WHERE id_cob = " + key[0] + " AND id_dnc = " + key[1] + " ";
