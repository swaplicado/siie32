 ...
 */
public class SDataDpsDocumentNumberingCenter extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataDpsDocumentNumberingCenter() {
        super(SDataConstants.TRN_DNC_DPS);
        reset();
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dnc_dps WHERE id_dnc = " + key[0] + " ";
