 ...
 */
public final class SRowCfdiTaxImport33 extends erp.lib.table.STableRow {
     ...
     */
    public SRowCfdiTaxImport33(cfd.ver33.DElementConceptoImpuestos impuestos, int taxType, int row){
    ...
    public void prepareTableRow() {
        ...
        switch (mnTaxType) {
            case SModSysConsts.FINS_TP_TAX_CHARGED:
                ...
                mvValues.add(DCfdi33Catalogs.DescripcionImpuestoTrasladado);
            ...
            case SModSysConsts.FINS_TP_TAX_RETAINED:
                ...
                mvValues.add(DCfdi33Catalogs.DescripcionImpuestoRetenido);
