 ...
 */
public class SProcUpdateCtrStatus extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcUpdateCtrStatus() {
        super(SProcConstants.TRN_CTR_UPD_ST);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_ctr_upd_st(?, ?, ?, ?, ?, ?) }");
