 ...
 */
public class SDataDpsDocumentNumberSeries extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataDpsDocumentNumberSeries() {
        super(SDataConstants.TRN_DNS_DPS);
        reset();
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dns_dps WHERE id_dns = " + key[0] + " ";
