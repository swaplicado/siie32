 ...
 */
public class SDataStockConfig extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataStockConfig() {
        super(SDataConstants.TRN_STK_CFG);
        reset();
    }
    ...
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkItemId, mnPkUnitId, mnPkCompanyBranchId, mnPkWarehouseId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_stk_cfg " +
                    "WHERE id_item = " + key[0] + " AND id_unit = " + key[1] + " AND id_cob = " + key[2] + " AND id_wh = " + key[3] +  " ";
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            ...
            callableStatement.setDouble(nParam++, mdQuantityMaximum);
            callableStatement.setDouble(nParam++, mdReorderPoint);
