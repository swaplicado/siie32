 ...
 */
public class SProcDpsDocumentNumberingCenterVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcDpsDocumentNumberingCenterVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL trn_dnc_dps_val(?, ?, ?) }");
