 ...
 */
public class SDataDiogDncCompanyBranchEntity extends erp.lib.data.SDataRegistry implements java.io.Serializable {
    ...
    public SDataDiogDncCompanyBranchEntity() {
        super(SDataConstants.TRN_DNC_DIOG_COB_ENT);
        reset();
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM trn_dnc_diog_cob_ent WHERE id_cob = " + key[0] + " AND id_ent = " + key[1] + "  AND id_dnc = " + key[2] + " ";
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall(
                    "{ CALL trn_dnc_diog_cob_ent_save(" +
                    "?, ?, ?, ?, ?, ?, ?) }");
