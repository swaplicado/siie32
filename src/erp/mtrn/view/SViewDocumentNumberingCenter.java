 ...
 */
public class SViewDocumentNumberingCenter extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewDocumentNumberingCenter(erp.client.SClientInterface client, java.lang.String tabTitle, int auxType) {
    ...
    private void initComponents() {
        ...
        i = 0;
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "d.dnc", "Centro foliado", 200);
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT d.id_dnc, d.dnc, d.b_can_edit, d.b_can_del, d.b_del, " +
                "d.b_can_edit AS " + STableConstants.FIELD_IS_EDITABLE + ", " +
