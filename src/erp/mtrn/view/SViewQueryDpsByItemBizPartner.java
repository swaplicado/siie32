...
public class SViewQueryDpsByItemBizPartner extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
    ...
    private void renderTableColumns() {
        ...
        maoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "de.price_u_cur", "Precio unitario moneda$", STableConstants.WIDTH_VALUE_2X);
        maoTableColumns[i++].setCellRenderer(miClient.getSessionXXX().getFormatters().getTableCellRendererValueUnitary());
        maoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "de.stot_cur_r", "Subtotal moneda $", STableConstants.WIDTH_VALUE_2X);
        maoTableColumns[i++].setSumApplying(true);
        maoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "de.tax_charged_cur_r", "Imp. tras. moneda $", STableConstants.WIDTH_VALUE);
        maoTableColumns[i++].setSumApplying(true);
        maoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "de.tax_retained_cur_r", "Imp. ret. moneda $", STableConstants.WIDTH_VALUE);
        maoTableColumns[i++].setSumApplying(true);
        maoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "de.tot_cur_r", "Total moneda $", STableConstants.WIDTH_VALUE_2X);
        maoTableColumns[i++].setSumApplying(true);
