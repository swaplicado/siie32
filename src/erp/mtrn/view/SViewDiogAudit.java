 ...
 */
public class SViewDiogAudit extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
     ...
     * @param auxType01 Constants defined in SDataConstants (TRNX_DIOG_AUDIT_PEND or TRNX_DIOG_AUDITED).
     */
    public SViewDiogAudit(erp.client.SClientInterface client, java.lang.String tabTitle, int auxType01) {
    ...
    private void initComponents() {
        ...
        addTaskBarUpperComponent(isDiogAuditPending() ? moTabFilterDateCutOff : moTabFilterDatePeriod);
        addTaskBarUpperSeparator();
        ...
        mjbAuditYes.setEnabled(isDiogAuditPending());
        mjbAuditNo.setEnabled(!isDiogAuditPending());
        ...
        mvSuscriptors.add(SDataConstants.TRNX_DIOG_AUDIT_PEND);
        mvSuscriptors.add(SDataConstants.TRNX_DIOG_AUDITED);
    ...
    private boolean isDiogAuditPending() {
        return mnTabTypeAux01 == SDataConstants.TRNX_DIOG_AUDIT_PEND;
    }
    ...
    public void createSqlQuery() {
        ...
        sqlWhere += (sqlWhere.length() == 0 ? "" : "AND ") + " iog.b_audit = " + !isDiogAuditPending() + " ";
