...
public class SViewDpsBalanceAging extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
    ...
    private void initComponents() {
        ...
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "f_cred_lim", "Lím. crédito", STableConstants.WIDTH_QUANTITY);
        ...
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range1", "1-15", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range2", "16-30", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range3", "31-45", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range4", "46-60", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range5", "61-90", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range6", "91-180", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range7", "181-360", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "range8", "Más de 360", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "def", "Vencido", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
        aoTableColumns[i] = new STableColumn(SLibConstants.DATA_TYPE_DOUBLE, "byDef", "Por vencer", STableConstants.WIDTH_QUANTITY);
        aoTableColumns[i++].setSumApplying(true);
