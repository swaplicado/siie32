 ...
 * 
 * @author  Sergio Flores, Uriel Castañeda, Juan Barajas, Isabel Servín, Sergio Flores, Edwin Carmona, Adrian Aviles
 * @version 3.2
 */
public class SClient extends JFrame implements SClientInterface, SGuiClient, ActionListener {
    ...
    public static final String APP_RELEASE = "3.2 294.20"; // release date: 2026-02-04
