 ...
 * 
 * @author  Sergio Flores, Uriel Castañeda, Juan Barajas, Isabel Servín, Rodrigo Ayala, Claudio Peña, Edwin Carmona, Sergio Flores
 * @version 3.2
 */
public class SClient extends JFrame implements SClientInterface, SGuiClient, ActionListener {
    ...
    public static final String APP_RELEASE = "3.2 305.0"; // release date: 2026-07-20
