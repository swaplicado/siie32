 ...
 */
public class SDialogMassAccount extends SBeanFormDialog implements ActionListener, ListSelectionListener, ItemListener {
     ...
     */
    public SDialogMassAccount(SGuiClient client) {
    ...
    private void initComponents() {
        ...
        jpConcepts = new javax.swing.JPanel();
        jpBol = new javax.swing.JPanel();
        jpBol1 = new javax.swing.JPanel();
        jlBolVersion = new javax.swing.JLabel();
        ...
        jpAccounting1 = new javax.swing.JPanel();
        jlAcc = new javax.swing.JLabel();
        jtfAccItem = new javax.swing.JTextField();
        jbAccPickItem = new javax.swing.JButton();
        jtfAccItemAux = new javax.swing.JTextField();
        jbAccPickItemAux = new javax.swing.JButton();
        moIntAccUnits = new sa.lib.gui.bean.SBeanFieldInteger();
        moKeyAccUnit = new sa.lib.gui.bean.SBeanFieldKey();
        jtfAccAccount = new javax.swing.JTextField();
        jbAccPickAccount = new javax.swing.JButton();
        jtfAccCostCenter = new javax.swing.JTextField();
        jbAccPickCostCenter = new javax.swing.JButton();
        jpAccounting2 = new javax.swing.JPanel();
        jlSug = new javax.swing.JLabel();
        jtfSugItem = new javax.swing.JTextField();
        jlSug1 = new javax.swing.JLabel();
        jtfSugItemAux = new javax.swing.JTextField();
        jlSug2 = new javax.swing.JLabel();
        jtfSugUnits = new javax.swing.JTextField();
        jtfSugUnit = new javax.swing.JTextField();
        jtfSugAccount = new javax.swing.JTextField();
        jlSug3 = new javax.swing.JLabel();
        jtfSugCostCenter = new javax.swing.JTextField();
        ...
        jbChangeRequiredPaymentDate1 = new javax.swing.JButton();
        ...
        jpSettings.add(jpDownloadW, java.awt.BorderLayout.WEST);
        ...
        jpDocumentVouchers.setLayout(new java.awt.BorderLayout());

        jpVouchers.setBorder(javax.swing.BorderFactory.createTitledBorder("Comprobantes:"));
        jpVouchers.setLayout(new java.awt.BorderLayout());
        jpDocumentVouchers.add(jpVouchers, java.awt.BorderLayout.CENTER);

        jpVouchersDetail.setLayout(new java.awt.GridLayout(2, 1));

        jpConcepts.setBorder(javax.swing.BorderFactory.createTitledBorder("Conceptos del comprobante:"));
        jpConcepts.setLayout(new java.awt.BorderLayout());
        jpVouchersDetail.add(jpConcepts);

        jpBol.setBorder(javax.swing.BorderFactory.createTitledBorder("Complemento carta porte del comprobante:"));
        jpBol.setLayout(new java.awt.GridLayout(4, 1, 0, 2));

        jpBol1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 0));

        jlBolVersion.setText("Versión:");
        jlBolVersion.setPreferredSize(new java.awt.Dimension(75, 23));
        jpBol1.add(jlBolVersion);

        jtfBolVersion.setEditable(false);
        jtfBolVersion.setText("TEXT");
        jtfBolVersion.setFocusable(false);
        jtfBolVersion.setPreferredSize(new java.awt.Dimension(50, 23));
        jpBol1.add(jtfBolVersion);

        jlBolDistanceKm.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlBolDistanceKm.setText("Total dist. recorrida (km):");
        jlBolDistanceKm.setPreferredSize(new java.awt.Dimension(150, 23));
        jpBol1.add(jlBolDistanceKm);
        ...
        jtfBolSrcAddress.setPreferredSize(new java.awt.Dimension(175, 23));
        ...
        jtfBolSrcDistrict.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolSrcLocality.setPreferredSize(new java.awt.Dimension(35, 23));
        ...
        jtfBolSrcLocality.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolSrcCounty.setPreferredSize(new java.awt.Dimension(45, 23));
        jpBol2.add(jlBolSrcCounty);

        jtfBolSrcCounty.setEditable(false);
        jtfBolSrcCounty.setText("TEXT");
        jtfBolSrcCounty.setFocusable(false);
        jtfBolSrcCounty.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolSrcState.setPreferredSize(new java.awt.Dimension(35, 23));
        jpBol2.add(jlBolSrcState);

        jtfBolSrcState.setEditable(false);
        jtfBolSrcState.setText("TEXT");
        jtfBolSrcState.setFocusable(false);
        jtfBolSrcState.setPreferredSize(new java.awt.Dimension(40, 23));
        ...
        jtfBolSrcCountry.setPreferredSize(new java.awt.Dimension(40, 23));
        ...
        jtfBolDesAddress.setPreferredSize(new java.awt.Dimension(175, 23));
        ...
        jtfBolDesDistrict.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolDesLocality.setPreferredSize(new java.awt.Dimension(35, 23));
        ...
        jtfBolDesLocality.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolDesCounty.setPreferredSize(new java.awt.Dimension(45, 23));
        jpBol3.add(jlBolDesCounty);

        jtfBolDesCounty.setEditable(false);
        jtfBolDesCounty.setText("TEXT");
        jtfBolDesCounty.setFocusable(false);
        jtfBolDesCounty.setPreferredSize(new java.awt.Dimension(50, 23));
        ...
        jlBolDesState.setPreferredSize(new java.awt.Dimension(35, 23));
        jpBol3.add(jlBolDesState);

        jtfBolDesState.setEditable(false);
        jtfBolDesState.setText("TEXT");
        jtfBolDesState.setFocusable(false);
        jtfBolDesState.setPreferredSize(new java.awt.Dimension(40, 23));
        jtfBolDesState.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfBolDesStateActionPerformed(evt);
            }
        });
        ...
        jtfBolDesCountry.setPreferredSize(new java.awt.Dimension(40, 23));
        ...
        jlBolGood.setPreferredSize(new java.awt.Dimension(75, 23));
        ...
        jtfBolGoodDescrip.setPreferredSize(new java.awt.Dimension(325, 23));
        ...
        jtfBolGoodUnitDescrip.setPreferredSize(new java.awt.Dimension(100, 23));
        ...
        jtfBolGoodWeightKg.setPreferredSize(new java.awt.Dimension(75, 23));
        jpBol4.add(jtfBolGoodWeightKg);

        jpBol.add(jpBol4);

        jpVouchersDetail.add(jpBol);

        jpDocumentVouchers.add(jpVouchersDetail, java.awt.BorderLayout.SOUTH);

        jpDocumentsRendering.add(jpDocumentVouchers, java.awt.BorderLayout.CENTER);

        jpAccounting.setBorder(javax.swing.BorderFactory.createTitledBorder("Contabilización del comprobante:"));
        jpAccounting.setLayout(new java.awt.GridLayout(2, 1, 0, 2));

        jpAccounting1.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 0));

        jlAcc.setText("Contabilizar:");
        jlAcc.setPreferredSize(new java.awt.Dimension(75, 23));
        jpAccounting1.add(jlAcc);

        jtfAccItem.setEditable(false);
        jtfAccItem.setText("TEXT");
        jtfAccItem.setToolTipText("Ítem");
        jtfAccItem.setFocusable(false);
        jtfAccItem.setPreferredSize(new java.awt.Dimension(150, 23));
        jpAccounting1.add(jtfAccItem);

        jbAccPickItem.setText("...");
        jbAccPickItem.setToolTipText("Seleccionar ítem...");
        jbAccPickItem.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting1.add(jbAccPickItem);
        ...
        jpAccounting1.add(jtfAccItemAux);

        jbAccPickItemAux.setText("...");
        jbAccPickItemAux.setToolTipText("Seleccionar ítem auxiliar...");
        jbAccPickItemAux.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting1.add(jbAccPickItemAux);

        moIntAccUnits.setToolTipText("Unidades");
        moIntAccUnits.setPreferredSize(new java.awt.Dimension(75, 23));
        jpAccounting1.add(moIntAccUnits);

        moKeyAccUnit.setToolTipText("Unidad");
        moKeyAccUnit.setPreferredSize(new java.awt.Dimension(50, 23));
        jpAccounting1.add(moKeyAccUnit);
        ...
        jpAccounting1.add(jtfAccAccount);

        jbAccPickAccount.setText("...");
        jbAccPickAccount.setToolTipText("Seleccionar cuenta contable...");
        jbAccPickAccount.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting1.add(jbAccPickAccount);
        ...
        jpAccounting1.add(jtfAccCostCenter);

        jbAccPickCostCenter.setText("...");
        jbAccPickCostCenter.setToolTipText("Seleccionar centro de costo...");
        jbAccPickCostCenter.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting1.add(jbAccPickCostCenter);

        jpAccounting.add(jpAccounting1);

        jpAccounting2.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 0));

        jlSug.setText("Sugerencia:");
        jlSug.setPreferredSize(new java.awt.Dimension(75, 23));
        jpAccounting2.add(jlSug);

        jtfSugItem.setEditable(false);
        jtfSugItem.setText("TEXT");
        jtfSugItem.setToolTipText("Ítem");
        jtfSugItem.setFocusable(false);
        jtfSugItem.setPreferredSize(new java.awt.Dimension(150, 23));
        jpAccounting2.add(jtfSugItem);

        jlSug1.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting2.add(jlSug1);

        jtfSugItemAux.setEditable(false);
        jtfSugItemAux.setText("TEXT");
        jtfSugItemAux.setToolTipText("Ítem auxiliar");
        jtfSugItemAux.setFocusable(false);
        jtfSugItemAux.setPreferredSize(new java.awt.Dimension(150, 23));
        jpAccounting2.add(jtfSugItemAux);

        jlSug2.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting2.add(jlSug2);

        jtfSugUnits.setEditable(false);
        jtfSugUnits.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jtfSugUnits.setText("0");
        jtfSugUnits.setToolTipText("Unidades");
        jtfSugUnits.setFocusable(false);
        jtfSugUnits.setPreferredSize(new java.awt.Dimension(75, 23));
        jpAccounting2.add(jtfSugUnits);

        jtfSugUnit.setEditable(false);
        jtfSugUnit.setText("TEXT");
        jtfSugUnit.setToolTipText("Unidad");
        jtfSugUnit.setFocusable(false);
        jtfSugUnit.setPreferredSize(new java.awt.Dimension(50, 23));
        jpAccounting2.add(jtfSugUnit);

        jtfSugAccount.setEditable(false);
        jtfSugAccount.setText("0000-0000-0000");
        jtfSugAccount.setToolTipText("Cuenta contable");
        jtfSugAccount.setFocusable(false);
        jtfSugAccount.setPreferredSize(new java.awt.Dimension(100, 23));
        jpAccounting2.add(jtfSugAccount);

        jlSug3.setPreferredSize(new java.awt.Dimension(23, 23));
        jpAccounting2.add(jlSug3);

        jtfSugCostCenter.setEditable(false);
        jtfSugCostCenter.setText("000-00-00-000");
        jtfSugCostCenter.setToolTipText("Centro de costo");
        jtfSugCostCenter.setFocusable(false);
        jtfSugCostCenter.setPreferredSize(new java.awt.Dimension(95, 23));
        jpAccounting2.add(jtfSugCostCenter);

        jpAccounting.add(jpAccounting2);
        ...
        sBeanFieldBoolean1.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        sBeanFieldBoolean1.setPreferredSize(new java.awt.Dimension(150, 23));
        jpProcessingN9.add(sBeanFieldBoolean1);
        ...
        sBeanFieldDecimal1.setPreferredSize(new java.awt.Dimension(105, 23));
        jpProcessingN1.add(sBeanFieldDecimal1);

        jbChangeRequiredPaymentDate1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/erp/img/icon_std_edit.gif"))); // NOI18N
        jbChangeRequiredPaymentDate1.setToolTipText("Cambiar fecha requerida de pago...");
        jbChangeRequiredPaymentDate1.setPreferredSize(new java.awt.Dimension(23, 23));
        jpProcessingN1.add(jbChangeRequiredPaymentDate1);
        ...
        jpProcessingN11.add(jtfReqPayReqDate);
    ...
    private void jtfBolDesStateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfBolDesStateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfBolDesStateActionPerformed
    ...
    private javax.swing.JLabel jlBolVersion;
    private javax.swing.JLabel jlInvoice;
    private javax.swing.JLabel jlLabelWeek1;
    private javax.swing.JLabel jlLabelWeek2;
    private javax.swing.JLabel jlSug;
    private javax.swing.JLabel jlSug1;
    private javax.swing.JLabel jlSug2;
    private javax.swing.JLabel jlSug3;
    private javax.swing.JLabel jlUser;
    private javax.swing.JPanel jpAccounting;
    private javax.swing.JPanel jpAccounting1;
    private javax.swing.JPanel jpAccounting2;
    private javax.swing.JPanel jpBol;
    private javax.swing.JPanel jpBol1;
    private javax.swing.JPanel jpBol2;
    private javax.swing.JPanel jpBol3;
    private javax.swing.JPanel jpBol4;
    private javax.swing.JPanel jpConcepts;
    private javax.swing.JPanel jpDocumentVouchers;
    ...
    private javax.swing.JTextField jtfSugItemAux;
    private javax.swing.JTextField jtfSugUnit;
    ...
    private sa.lib.gui.bean.SBeanFieldInteger moIntAccUnits;
    private sa.lib.gui.bean.SBeanFieldKey moKeyAccUnit;
    ...
    private void initComponentsCustom() {
        ...
        */
        ...
        jpDocumentsRendering.add(moDocumentsGrid, BorderLayout.CENTER);
