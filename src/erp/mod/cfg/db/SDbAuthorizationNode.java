 ...
 */
public class SDbAuthorizationNode extends SDbRegistryUser {
...
//    protected Date mtTsUserUpdate;
    ...
    public SDbAuthorizationNode() {
        super(SModConsts.CFGU_AUTHORN_NODE);
    }
...
//    public Date getTsUserUpdate() { return mtTsUserUpdate; }
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkAuthorizationNodeId };
    }
    ...
    public String getSqlWhere() {
        return "WHERE id_authorn_node = " + mnPkAuthorizationNodeId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_authorn_node = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_authorn_node), 0) + 1 FROM " + getSqlTable() + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkAuthorizationNodeId = resultSet.getInt(1);
        }
    }
...
//                    "ts_usr_ins = " + "NOW()" + ", " +
    ...
    public SDbRegistry clone() throws CloneNotSupportedException {
        SDbAuthorizationNode registry = new SDbAuthorizationNode();
