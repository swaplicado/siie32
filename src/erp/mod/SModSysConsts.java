...
public abstract class SModSysConsts {
    ...
    public static final int ITMU_ITEM_INV = 101;
    ...
    public static final int FINS_ST_PAY_SCHED = 4; // autorizado
    public static final int FINS_ST_PAY_EXEC = 5; // operado
    public static final int FINS_ST_PAY_SUBR = 6; // por operarse
    ...
    public static final int FINS_ST_PAY_SCHED_P = 14; // autorizado (en proceso)
    public static final int FINS_ST_PAY_EXEC_P = 15; // operado (en proceso)
    public static final int FINS_ST_PAY_SUBR_P = 16; // por operarse (en proceso)
    ...
    public static final int HRSS_BONUS_WEEKS = 1; // Cuantas semanas para checar bonos
