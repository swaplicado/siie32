 ...
 * @author Juan Barajas
 */
public class SFormSpotCompanyBranchEntity extends sa.lib.gui.bean.SBeanForm {

    private SDbSpotCompanyBranchEntity moRegistry;
    private SGuiFieldKeyGroup moFieldKeyEntityGroup;

    /**
     * Creates new form SFormSpotCompanyBranchEntity
     */
    public SFormSpotCompanyBranchEntity(SGuiClient client, String title) {
    ...
    private void initComponents() {
        ...
        moKeyCompanyBranchEntity = new sa.lib.gui.bean.SBeanFieldKey();
        ...
        jlCompanyBranchEntity.setForeground(new java.awt.Color(0, 0, 255));
        jlCompanyBranchEntity.setText("Entidad:*");
        jlCompanyBranchEntity.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel31.add(jlCompanyBranchEntity);

        moKeyCompanyBranchEntity.setPreferredSize(new java.awt.Dimension(200, 23));
        jPanel31.add(moKeyCompanyBranchEntity);
    ...
    private sa.lib.gui.bean.SBeanFieldKey moKeyCompanyBranchEntity;
    ...
    private void initComponentsCustom() {
        ...
        moKeyCompanyBranchEntity.setKeySettings(miClient, SGuiUtils.getLabelName(jlCompanyBranchEntity.getText()), true);
        moKeySpot.setKeySettings(miClient, SGuiUtils.getLabelName(jlSpot.getText()), true);

        moFields.addField(moKeyCompanyBranch);
        moFields.addField(moKeyCompanyBranchEntity);
    ...
    public void reloadCatalogues() {
        ...
        moFieldKeyEntityGroup.addFieldKey(moKeyCompanyBranch, SModConsts.BPSU_BPB, ((SSessionCustom) miClient.getSession().getSessionCustom()).getCurrentCompanyKey()[0], null);
        moFieldKeyEntityGroup.addFieldKey(moKeyCompanyBranchEntity, SModConsts.CFGU_COB_ENT, SModSysConsts.CFGS_CT_ENT_WH, null);
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        int[] key = null;
        moRegistry = (SDbSpotCompanyBranchEntity) registry;
        ...
        moKeyCompanyBranch.setValue(new int[] {key[0] });
        moKeyCompanyBranchEntity.setValue(new int[] { key[0], key[1] });
        ...
        if (moRegistry.isRegistryNew()) {
            ...
            moKeyCompanyBranchEntity.setEnabled(false);
        }
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbSpotCompanyBranchEntity registry = moRegistry.clone();

        if (registry.isRegistryNew()) {}

        moRegistry.setPkCompanyBranchId(moKeyCompanyBranch.getValue()[0]);
        moRegistry.setPkEntityId(moKeyCompanyBranchEntity.getValue()[1]);
