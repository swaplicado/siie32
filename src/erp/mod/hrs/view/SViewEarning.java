...
public class SViewEarning extends SGridPaneView implements ActionListener {
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_DEC_8D, "v.exem_mwz_year", "UMA exentas (opcional)"));
        ...
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_DEC_8D, "v.exem_sal_grt_mwz_lim", "Límite exención si SB > SMA"));
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_DEC_PER_4D, "v.pay_per", "% pago"));
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_DEC_AMT_UNIT, "v.unt_max_wee", "No. unidades máximas"));
