...
public class SViewAutomaticEarnings extends SGridPaneView implements ActionListener {
    ...
    public SViewAutomaticEarnings(SGuiClient client, int gridSubtype, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.HRSX_AUT_EAR, gridSubtype, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + (mnGridSubtype == SModSysConsts.HRS_AUT_GBL ? "ORDER BY v.id_ear, v.id_aut " : "ORDER BY bp.bp, v.fk_emp_n ");
    }
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        if (mnGridSubtype == SModSysConsts.HRS_AUT_GBL) {
            gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_CAT_M, "ear.name", SGridConsts.COL_TITLE_NAME));
            gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_CODE_CAT, "ear.code", SGridConsts.COL_TITLE_CODE));
