 ...
 */
public class SViewAutomaticEarnings extends SGridPaneView implements ActionListener {
     ...
     */
    public SViewAutomaticEarnings(SGuiClient client, int gridSubtype, String title) {
     ...
     */
    public SViewAutomaticEarnings(SGuiClient client, int gridSubtype, String title, SGuiParams params) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.HRSX_AUT_EAR, gridSubtype, title, params);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.HRS_AUT_EAR) + " AS v "
                ...
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.HRSS_TP_EAR_COMP) + " AS vtc ON "
                + "ear.fk_tp_ear_comp = vtc.id_tp_ear_comp "
                ...
                + (mnGridSubtype == SModSysConsts.HRS_AUT_GBL ? "ORDER BY ear.code, v.id_ear, v.id_aut " : "ORDER BY bp.bp, v.fk_emp_n" + (!mbShowDetailForEmployees ? "" : ", ear.code, v.id_ear, v.id_aut") + " ");
    }
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        if (mnGridSubtype == SModSysConsts.HRS_AUT_GBL || mbShowDetailForEmployees) {
            ...
            gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_CODE_CAT, "ear.code", SGridConsts.COL_TITLE_CODE + " percepción"));
            gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_CAT_M, "ear.name", SGridConsts.COL_TITLE_NAME + " percepción"));
