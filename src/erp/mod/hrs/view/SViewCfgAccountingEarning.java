 ...
 */
public class SViewCfgAccountingEarning extends SGridPaneView implements ActionListener {

    public SViewCfgAccountingEarning(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.HRS_CFG_ACC_EAR, 0, title);
    ...
    public void prepareSqlQuery() {
        ...
        if ((Boolean) filter) {
            sql += (sql.isEmpty() ? "" : "") + "NOT ca.b_del AND NOT ear.b_del ";
        }

        msSql = "SELECT "
                + "ca.id_ear AS " + SDbConsts.FIELD_ID + "1, "
                ...
                + "pcc.name, "
                + "ta.name, "
                + "IF(ca.fk_tp_acc_rec = ear.fk_tp_acc_rec, " + SGridConsts.ICON_OK + ", " + SGridConsts.ICON_WARN + ") AS _ta_ok, "
                + "bb.bp, "
                + "tax.tax, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.HRS_CFG_ACC_EAR) + " AS ca "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.HRS_EAR) + " AS ear ON ca.id_ear = ear.id_ear "
                ...
                + "ORDER BY ear.code, ear.name, ca.id_ear ";
    }
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_INT_ICON, "_ta_ok", SGridConsts.COL_TITLE_TYPE + " registro contable coincide con la percepción"));
        ...
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_BOOL_S, "ear.b_del", SGridConsts.COL_TITLE_IS_DEL + " percepción"));
