...
public class SViewPosition extends SGridPaneView {
    ...
    public SViewPosition(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.HRSU_POS, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.HRSU_POS) + " AS v "
                ...
                + "ORDER BY dep.name, dep.id_dep, v.name, v.id_pos ";
    }
