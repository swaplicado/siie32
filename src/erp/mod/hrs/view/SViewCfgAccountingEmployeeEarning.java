 ...
 */
public class SViewCfgAccountingEmployeeEarning extends SGridPaneView {

    public SViewCfgAccountingEmployeeEarning(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.HRS_CFG_ACC_EMP_EAR, 0, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "ca.id_ear AS " + SDbConsts.FIELD_ID + "2, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.HRS_CFG_ACC_EMP_EAR) + " AS ca "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.HRS_EAR) + " AS c ON "
                + "ca.id_ear = c.id_ear "
                ...
                + "ORDER BY ebp.bp, e.num, ca.id_emp, c.code, c.name, c.id_ear ";
    }
