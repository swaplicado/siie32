 ...
 */
public class SFormAbsenceClass extends SBeanForm {

    private SDbAbsenceClass moRegistry;

    /**
     * Creates new form SFormAbsenceClass
     */
    public SFormAbsenceClass(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.HRSU_CL_ABS, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbAbsenceClass) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbAbsenceClass registry = moRegistry.clone();
