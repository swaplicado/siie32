...
public class SFormPaysheetCustomType extends SBeanForm {
    ...
    private void initComponents() {
        ...
        jlOneOff = new javax.swing.JLabel();
        moBolOneOff = new sa.lib.gui.bean.SBeanFieldBoolean();
        ...
        jlOneOff.setText("Único:*");
        jlOneOff.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel6.add(jlOneOff);
        jPanel6.add(moBolOneOff);
    ...
    private javax.swing.JLabel jlOneOff;
    private sa.lib.gui.bean.SBeanFieldBoolean moBolOneOff;
    ...
    private void initComponentsCustom() {
        ...
        moBolOneOff.setBooleanSettings(SGuiUtils.getLabelName(jlOneOff.getText()), false);

        moFields.addField(moTextCode);
        moFields.addField(moTextName);
        moFields.addField(moBolOneOff);
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        ...
        moBolOneOff.setValue(moRegistry.isOneOff());
    ...
    public SDbRegistry getRegistry() throws Exception {
        ...
        registry.setOneOff(moBolOneOff.getValue());
