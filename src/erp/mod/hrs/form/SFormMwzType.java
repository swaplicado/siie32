 ...
 */
public class SFormMwzType extends SBeanForm {

    private SDbMwzType moRegistry;

    /**
     * Creates new form SFormMwzType
     */
    public SFormMwzType(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.HRSU_TP_MWZ, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbMwzType) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbMwzType registry = moRegistry.clone();
