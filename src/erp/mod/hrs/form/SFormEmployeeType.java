 ...
 */
public class SFormEmployeeType extends SBeanForm {

    private SDbEmployeeType moRegistry;

    /**
     * Creates new form SFormEmployeeType
     */
    public SFormEmployeeType(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.HRSU_TP_EMP, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbEmployeeType) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbEmployeeType registry = moRegistry.clone();
