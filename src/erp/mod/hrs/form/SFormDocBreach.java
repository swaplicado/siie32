...
public class SFormDocBreach extends SBeanForm implements ActionListener {
    ...
    private int mnCfgParamDepartmentId;
    private int mnCfgParamReRepCompanyId;
    private int mnCfgParamReRepUnionId;
    ...
    private void initComponents() {
        ...
        jlOffender = new javax.swing.JLabel();
        ...
        jPanelDocN.setLayout(new java.awt.GridLayout(10, 1, 0, 5));
        ...
        jlOffender.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanelDocN7.add(jlOffender);
        ...
        jckOffenderUnionized.setPreferredSize(new java.awt.Dimension(150, 23));
        ...
        jckOffenderActive.setPreferredSize(new java.awt.Dimension(150, 23));
        jPanelDocN7.add(jckOffenderActive);
        ...
        jlEmployeeUnion_n.setText("Repres. sindical:");
        ...
        jlBreachAbstract.setText("Infracción:*");
        ...
        jlBreachDescrip.setText("Descripción de la infracción:*");
    ...
    private javax.swing.JLabel jlOffender;
    ...
    private void initComponentsCustom() {
        ...
        try {
            mnCfgParamDepartmentId = SLibUtils.parseInt(SCfgUtils.getParamValue(miClient.getSession().getStatement(), SDataConstantsSys.CFG_PARAM_DOC_HRS_DEP));
            mnCfgParamReRepCompanyId = SLibUtils.parseInt(SCfgUtils.getParamValue(miClient.getSession().getStatement(), SDataConstantsSys.CFG_PARAM_DOC_HRS_REP_COM));
            mnCfgParamReRepUnionId = SLibUtils.parseInt(SCfgUtils.getParamValue(miClient.getSession().getStatement(), SDataConstantsSys.CFG_PARAM_DOC_HRS_REP_UNI));
        }
        catch (Exception e) {
    ...
    private void showOffenderData(final int departmentId, final int positionId, final boolean unionized, final boolean active) {
        ...
        if (departmentId == 0) {
            ...
            jtfOffenderDepartmentName.setText((String) miClient.getSession().readField(SModConsts.HRSU_DEP, new int[] { departmentId }, SDbRegistry.FIELD_NAME));
            jtfOffenderDepartmentCode.setText((String) miClient.getSession().readField(SModConsts.HRSU_DEP, new int[] { departmentId }, SDbRegistry.FIELD_CODE));
        ...
        if (positionId == 0) {
            ...
            jtfOffenderPositionName.setText((String) miClient.getSession().readField(SModConsts.HRSU_POS, new int[] { positionId }, SDbRegistry.FIELD_NAME));
            jtfOffenderPositionCode.setText((String) miClient.getSession().readField(SModConsts.HRSU_POS, new int[] { positionId }, SDbRegistry.FIELD_CODE));
        ...
        showEmployee(SPickerEmployee.MODE_REP_UNI, !unionized ? 0 : mnCfgParamReRepUnionId, false);
    }
