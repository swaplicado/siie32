 ...
 */
public class SFormWorkerType extends SBeanForm {

    private SDbWorkerType moRegistry;

    /**
     * Creates new form SFormWorkerType
     */
    public SFormWorkerType(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.HRSU_TP_WRK, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbWorkerType) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbWorkerType registry = moRegistry.clone();
