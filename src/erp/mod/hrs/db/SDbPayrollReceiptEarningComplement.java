 ...
 * @author Juan Barajas
 */
public class SDbPayrollReceiptEarningComplement extends SDbRegistryUser {
    ...
    */
    ...
    public SDbPayrollReceiptEarningComplement() {
        super(SModConsts.HRS_PAY_RCP_EAR_CMP);
    }
    ...
    @Override
    public SDbPayrollReceiptEarningComplement clone() throws CloneNotSupportedException {
        SDbPayrollReceiptEarningComplement registry = new SDbPayrollReceiptEarningComplement();
