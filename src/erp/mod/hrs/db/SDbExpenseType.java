 ...
 */
public class SDbExpenseType extends SDbRegistryUser {
    ...
    */
    ...
    public SDbExpenseType() {
        super(SModConsts.HRSU_TP_EXP);
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_tp_exp), 0) + 1 FROM " + getSqlTable() + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkExpenseTypeId = resultSet.getInt(1);
        }
    }
    ...
    @Override
    public SDbExpenseType clone() throws CloneNotSupportedException {
        SDbExpenseType registry = new SDbExpenseType();
