...
public class SDbAbsenceClass extends SDbRegistryUser {
    ...
    */
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkAbsenceClassId };
    }
    ...
    public String getSqlWhere() {
        return "WHERE id_cl_abs = " + mnPkAbsenceClassId + " ";
    }

    @Override
    public String getSqlWhere(int[] pk) {
        return "WHERE id_cl_abs = " + pk[0] + " ";
    }
    ...
    public void computePrimaryKey(SGuiSession session) throws SQLException, Exception {
        ...
        msSql = "SELECT COALESCE(MAX(id_cl_abs), 0) + 1 FROM " + getSqlTable() + " ";
        resultSet = session.getStatement().executeQuery(msSql);
        if (resultSet.next()) {
            mnPkAbsenceClassId = resultSet.getInt(1);
        }
    }
    ...
    @Override
    public SDbAbsenceClass clone() throws CloneNotSupportedException {
        SDbAbsenceClass registry = new SDbAbsenceClass();
