 ...
 */
public class SDbCfgAccountingEmployeeEarning extends SDbRegistryUser {
    ...
    */
    ...
    public SDbCfgAccountingEmployeeEarning() {
        super(SModConsts.HRS_CFG_ACC_EMP_EAR);
    }
    ...
    public int[] getPrimaryKey() {
        return new int[] { mnPkEmployeeId, mnPkEarningId };
    }
    ...
    @Override
    public SDbCfgAccountingEmployeeEarning clone() throws CloneNotSupportedException {
        SDbCfgAccountingEmployeeEarning registry = new SDbCfgAccountingEmployeeEarning();
