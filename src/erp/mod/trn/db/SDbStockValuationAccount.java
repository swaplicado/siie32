...
public class SDbStockValuationAccount extends SDbRegistryUser {
    ...
    public void read(SGuiSession session, int[] pk) throws SQLException, Exception {
        ...
        if (!resultSet.next()) {
            ...
            mnFkFinRecYearId = resultSet.getInt("fk_fin_rec_year_n");
            mnFkFinRecPerId = resultSet.getInt("fk_fin_rec_per_n");
            mnFkFinRecBkcId = resultSet.getInt("fk_fin_rec_bkc_n");
            msFkFinRecTpRecId = resultSet.getString("fk_fin_rec_tp_rec_n");
            mnFkFinRecNum = resultSet.getInt("fk_fin_rec_num_n");
            mnFkFinRecEty = resultSet.getInt("fk_fin_rec_ety_n");
    ...
    public void save(SGuiSession session) throws SQLException, Exception {
        ...
        if (mbRegistryNew) {
            ...
            msSql = "UPDATE " + getSqlTable() + " SET " +
                    ...
                    "b_del = " + (mbDeleted ? 1 : 0) + ", " +
                    "fk_fin_rec_year_n = " + mnFkFinRecYearId + ", " +
                    "fk_fin_rec_per_n = " + mnFkFinRecPerId + ", " +
                    "fk_fin_rec_bkc_n = " + mnFkFinRecBkcId + ", " +
                    "fk_fin_rec_tp_rec_n = '" + msFkFinRecTpRecId + "', " +
                    "fk_fin_rec_num_n = " + mnFkFinRecNum + ", " +
                    "fk_fin_rec_ety_n = " + mnFkFinRecEty + ", " +
