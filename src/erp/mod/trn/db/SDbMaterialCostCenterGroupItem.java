 ...
 */
public class SDbMaterialCostCenterGroupItem extends SDbRegistryUser {
    ...
    public SDbMaterialCostCenterGroupItem() {
        super(SModConsts.TRN_MAT_CC_GRP_ITEM);
    }
    ...
    public void setFkUser(int n) { mnFkUserId = n; }
    ...
    public int getFkUser() { return mnFkUserId; }
    ...
    @Override
    public SDbMaterialCostCenterGroupItem clone() throws CloneNotSupportedException {
        SDbMaterialCostCenterGroupItem registry = new SDbMaterialCostCenterGroupItem();
        ...
        registry.setFkUser(this.getFkUser());
