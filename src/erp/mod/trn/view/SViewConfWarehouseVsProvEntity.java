 ...
 */
public class SViewConfWarehouseVsProvEntity extends SGridPaneView implements ActionListener {
     ...
     */
    public SViewConfWarehouseVsProvEntity(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.TRNX_CONF_WHS_VS_PRV_ENT, SLibConsts.UNDEFINED, title, null);
