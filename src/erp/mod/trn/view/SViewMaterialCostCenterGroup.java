 ...
 */
public class SViewMaterialCostCenterGroup extends SGridPaneView {

    /**
     * @param client GUI client.
     * @param title View's GUI tab title.
     */
    public SViewMaterialCostCenterGroup(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.TRN_MAT_CC_GRP, SLibConsts.UNDEFINED, title, null);
        initComponents();
    }
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT v.id_mat_cc_grp AS " + SDbConsts.FIELD_ID + "1, "
                ...
                + "ORDER BY v.b_sys DESC, v.name, v.id_mat_cc_grp "; 
    }
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        columns.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_ITM_L, SDbConsts.FIELD_NAME, "Código centro de costo"));
