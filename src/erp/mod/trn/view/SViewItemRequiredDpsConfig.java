 ...
 * @author Juan Barajas
 */
public class SViewItemRequiredDpsConfig extends SGridPaneView {

    public SViewItemRequiredDpsConfig(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.TRNU_TP_DPS_SRC_ITEM, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                + "v.id_ct_dps AS " + SDbConsts.FIELD_ID + "1, "
                + "v.id_cl_dps AS " + SDbConsts.FIELD_ID + "2, "
                + "v.id_tp_dps AS " + SDbConsts.FIELD_ID + "3, "
                + "v.id_cfg AS " + SDbConsts.FIELD_ID + "4, "
                + "v.fk_tp_link AS " + SDbConsts.FIELD_FK + "1, "
                + "v.fk_ref AS " + SDbConsts.FIELD_FK + "2, "
                + "' ' AS " + SDbConsts.FIELD_CODE + ", "
                + "tp.tp_dps AS " + SDbConsts.FIELD_NAME + ", "
                + "vl.name, "
                + "CASE v.fk_tp_link "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.TRNU_TP_DPS_SRC_ITEM) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.TRNU_TP_DPS) + " AS tp ON v.id_ct_dps = tp.id_ct_dps AND v.id_ct_dps = tp.id_ct_dps AND v.id_cl_dps = tp.id_cl_dps AND v.id_tp_dps = tp.id_tp_dps "
                ...
                + "ORDER BY tp.tp_dps, v.id_ct_dps, v.id_cl_dps, v.id_tp_dps, v.id_cfg, f_ref, v.fk_tp_link, v.fk_ref ;";
    ...
    public ArrayList<SGridColumnView> createGridColumns() {
        ...
        gridColumnsViews.add(new SGridColumnView(SGridConsts.COL_TYPE_TEXT_NAME_CAT_M, SDbConsts.FIELD_NAME, "Tipo documento"));
    ...
    public void defineSuscriptions() {
        ...
        moSuscriptionsSet.add(SModConsts.TRNU_TP_DPS_SRC_ITEM);
