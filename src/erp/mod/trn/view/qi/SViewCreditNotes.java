    ...
    public void prepareSqlQuery() {
        ...
        moPaneSettings = new SGridPaneSettings(2);
               ...
               msSql = "SELECT d.id_year AS f_id_1, d.id_doc AS f_id_2, d.num_ref AS f_code, bp AS f_name, d.id_year, d.id_doc, d.dt, d.dt_doc_delivery_n, d.num_ref, d.comms_ref, d.exc_rate, d.stot_r, d.tax_charged_r, d.tax_retained_r, d.tot_r, d.stot_cur_r, d.tax_charged_cur_r, " +
                ...
                "IF(x.fid_st_xml = " + SModSysConsts.FINS_TP_ACC_NA + " OR LENGTH(uuid) = " + SModSysConsts.FINS_CFD_TAX_NA + ", " + STableConstants.ICON_XML_PEND + ", IF(LENGTH(x.ack_can_xml) = " + SModSysConsts.FINS_CFD_TAX_NA + " AND x.ack_can_pdf_n IS NULL, " + STableConstants.ICON_XML_SIGN + ", " +
                "IF(LENGTH(x.ack_can_xml) != " + SModSysConsts.FINS_CFD_TAX_NA + ", " + STableConstants.ICON_XML_CANC_XML + ", IF(x.ack_can_pdf_n IS NOT NULL, " + STableConstants.ICON_XML_CANC_PDF + ", " + STableConstants.ICON_XML_SIGN + " )))))) AS f_ico_xml, bp.id_bp, bp.bp, bpc.bp_key, bpb.id_bpb, bpb.bpb, " +
