 ...
 */
public class SViewInventoryValuationResults extends SGridPaneView {

    private SGridFilterDatePeriod moFilterDatePeriod;

    public SViewInventoryValuationResults(SGuiClient client, int gridSubtype, String title, SGuiParams params) {
