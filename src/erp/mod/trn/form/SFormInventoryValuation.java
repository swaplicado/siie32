 ...
 */
public class SFormInventoryValuation extends SBeanForm implements ActionListener, FocusListener {

    SDbInventoryValuation moRegistry;

    /**
     * Creates new form SFormInventoryValuation
     */
    public SFormInventoryValuation(SGuiClient client, int formSubtype, String title) {
        super();
        miClient = client;
        initComponents();
    ...
    private void initComponents() {
        ...
        jlStockValuation3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlStockValuation3.setText("Período");
        ...
        moKeyYear.setPreferredSize(new java.awt.Dimension(150, 23));
    ...
    */
    ...
    public SDbRegistry getRegistry() throws Exception {
        ...
        registry.setAuxPeriodQuery("BETWEEN '" + SLibUtils.DbmsDateFormatDate.format(moDateStart.getValue()) + "' AND '" +
                SLibUtils.DbmsDateFormatDate.format(moDateEnd.getValue()) + "' ");
        registry.setAuxAccountMask(SDataUtilities.createMaskFormatterAccountId((SClientInterface) miClient,
            ((SClientInterface) miClient).getSessionXXX().getParamsErp().getDeepAccounts()).replace("#", "0"));
