 ...
 */
public class SFormMmsConfig extends SBeanForm {

    private SDbMmsConfig moRegistry;

    /**
     * Creates new form SFormMMSItemConfiguration
     */
    public SFormMmsConfig(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.TRN_MMS_CFG, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponents() {
        ...
        jlTpMms = new javax.swing.JLabel();
        moKeyTpMms = new sa.lib.gui.bean.SBeanFieldKey();
        ...
        jlTextEmail = new javax.swing.JLabel();
        ...
        jlTpMms.setForeground(new java.awt.Color(0, 0, 255));
        jlTpMms.setText("Tipo de mensaje: *");
        jlTpMms.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel8.add(jlTpMms);

        moKeyTpMms.setPreferredSize(new java.awt.Dimension(300, 23));
        jPanel8.add(moKeyTpMms);
        ...
        moTextEmail.setText("sBeanFieldText1");
        moTextEmail.setPreferredSize(new java.awt.Dimension(350, 23));
    ...
    private javax.swing.JLabel jlTextEmail;
    private javax.swing.JLabel jlTpMms;
    private sa.lib.gui.bean.SBeanFieldKey moKeyLink;
    private sa.lib.gui.bean.SBeanFieldKey moKeyReference;
    private sa.lib.gui.bean.SBeanFieldKey moKeyTpMms;
    ...
    private void initComponentsCustom() {
        ...
        moKeyTpMms.setKeySettings(miClient, SGuiUtils.getLabelName(jlTpMms.getText()), true);
        ...
        moTextEmail.setTextSettings(SGuiUtils.getLabelName(jlTextEmail), 255);
        moTextEmail.setTextCaseType(3);
        
        moFields.addField(moKeyTpMms);
    ...
    public void reloadCatalogues() {
        miClient.getSession().populateCatalogue(moKeyTpMms, SModConsts.CFGS_TP_MMS, SLibConsts.UNDEFINED, null);
        miClient.getSession().populateCatalogue(moKeyLink, SModConsts.ITMS_LINK, SLibConsts.UNDEFINED, null);
    }

    @Override
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbMmsConfig) registry;
        ...
        moKeyTpMms.setValue(new int[] { moRegistry.getPkMmsTypeId() });
        moKeyLink.setValue(new int[] { moRegistry.getFkLinkTypeId() });
        
        moTextEmail.setValue(moRegistry.getEmail());
        
        setFormEditable(true);
        
        if (moRegistry.isRegistryNew()) {
            moKeyTpMms.setEnabled(true);
            itemStateChangedLinkType();     
        }
        else {
            moKeyTpMms.setEnabled(false);
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbMmsConfig registry = moRegistry.clone();
        
        if (registry.isRegistryNew()) {}
        
        moRegistry.setPkMmsTypeId(moKeyTpMms.getValue()[0]);
        ...
        moRegistry.setEmail(moTextEmail.getText());
    ...
    public SGuiValidation validateForm() {
        ...
        if (validation.isValid()) {
            email.addAll(Arrays.asList(SLibUtils.textExplode(moTextEmail.getValue(), ";")));
