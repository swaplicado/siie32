 ...
 */
public class SDialogMaterialRequestDocsCardex extends SBeanFormDialog implements ListSelectionListener {
    
    protected SGridPaneForm moGridLogs;
    protected ArrayList<SRowMaterialRequestDocs> mlLogs;
     ...
     * @param title
     */
    public SDialogMaterialRequestDocsCardex(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.TRNX_MAT_REQ_DOCS_KAR, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void showLog() {
        ...
        for (SRowMaterialRequestDocs oStep : mlLogs) {
            rows.add(oStep);
        }
