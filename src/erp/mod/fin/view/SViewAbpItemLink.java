 ...
 * @author Juan Barajas
 */
public class SViewAbpItemLink extends SGridPaneView {

    public SViewAbpItemLink(SGuiClient client, String title) {
        super(client, SGridConsts.GRID_PANE_VIEW, SModConsts.FIN_ABP_ITEM_LINK, SLibConsts.UNDEFINED, title);
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                + "v.id_abp_item AS " + SDbConsts.FIELD_ID + "1, "
                ...
                + "FROM " + SModConsts.TablesMap.get(SModConsts.FIN_ABP_ITEM_LINK) + " AS v "
                + "INNER JOIN " + SModConsts.TablesMap.get(SModConsts.FIN_ABP_ITEM) + " AS vi ON "
                + "v.id_abp_item = vi.id_abp_item "
                ...
                + "ORDER BY vi.name, vl.name, f_ref, v.id_abp_item, v.id_link, v.id_ref ";
