...
public class SViewBankLayout extends SGridPaneView implements ActionListener {
    ...
    public void prepareSqlQuery() {
        ...
        msSql = "SELECT "
                ...
                + "l.dt_lay, l.dt_due, l.cpt, l.con, l.amt, l.amt_pay, (l.amt - l.amt_pay) AS f_amt_x_pay, l.tra, l.tra_pay, (l.tra - l.tra_pay) AS f_tra_x_pay, l.doc, l.doc_pay, (l.doc - l.doc_pay) AS f_doc_x_pay, tp.tp_lay_bank AS f_tp_lay, "
                + "IF(tp.lay_bank = " + SFinConsts.LAY_BANK_HSBC + ", '" + SFinConsts.TXT_LAY_BANK_HSBC + "', IF(tp.lay_bank = " + SFinConsts.LAY_BANK_SANTANDER + ", '" + SFinConsts.TXT_LAY_BANK_SANTANDER + "', '" + SFinConsts.TXT_LAY_BANK_BANBAJIO + "')) AS f_lay, "
