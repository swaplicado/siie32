 ...
 * @author Juan Barajas
 */
public class SFormAbpItem extends sa.lib.gui.bean.SBeanForm {

    private SDbAbpItem moRegistry;
    private SDialogAbpEntry moDialogAbpEntry;
    private SGridPaneForm moGridAbpSettings;

    /**
     * Creates new form SFormAbp
     */
    public SFormAbpItem(SGuiClient client, String title) {
        setFormSettings(client, SGuiConsts.BEAN_FORM_EDIT, SModConsts.FIN_ABP_ITEM, SLibConsts.UNDEFINED, title);
        initComponents();
    ...
    private void initComponentsCustom() {
        ...
        moGridAbpSettings = new SGridPaneForm(miClient, SModConsts.FIN_ABP_ITEM, SLibConsts.UNDEFINED, "Configuraciones de contabilización") {
            @Override
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        moRegistry = (SDbAbpItem) registry;
    ...
    @Override
    public SDbAbpItem getRegistry() throws Exception {
        SDbAbpItem registry = moRegistry.clone();
