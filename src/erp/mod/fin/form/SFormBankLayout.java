...
public class SFormBankLayout extends SBeanForm implements ActionListener, ItemListener, CellEditorListener {
    ...
    */
    ...
    private void initComponents() {
        ...
        jpLayoutC = new javax.swing.JPanel();
        ...
        jbGridRowsAddPayments = new javax.swing.JButton();
        jbGridRowsClearPayments = new javax.swing.JButton();
        ...
        jpLayout.setBorder(javax.swing.BorderFactory.createTitledBorder("Datos del registro:"));
        jpLayout.setLayout(new java.awt.BorderLayout());

        jpLayoutW.setLayout(new java.awt.GridLayout(7, 1, 0, 3));
        ...
        jPanel4.add(jlDummy2);

        jpLayoutW.add(jPanel4);
        ...
        moKeyLayoutBank.setPreferredSize(new java.awt.Dimension(278, 23));
        jPanel5.add(moKeyLayoutBank);

        jpLayoutW.add(jPanel5);
        ...
        moKeyBankLayoutType.setPreferredSize(new java.awt.Dimension(278, 23));
        jPanel6.add(moKeyBankLayoutType);

        jpLayoutW.add(jPanel6);
        ...
        moKeyBankLayoutCurrency.setPreferredSize(new java.awt.Dimension(278, 23));
        jPanel8.add(moKeyBankLayoutCurrency);

        jpLayoutW.add(jPanel8);
        ...
        moKeyBankAccountCash.setPreferredSize(new java.awt.Dimension(278, 23));
        jPanel9.add(moKeyBankAccountCash);

        jpLayoutW.add(jPanel9);

        jPanel10.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 0));
        jpLayoutW.add(jPanel10);
        ...
        jpLayoutW.add(jPanel11);

        jpLayout.add(jpLayoutW, java.awt.BorderLayout.WEST);

        jpLayoutC.setLayout(new java.awt.GridLayout(7, 1, 0, 3));
        ...
        bgInput.add(moRadInputManual);
        moRadInputManual.setSelected(true);
        moRadInputManual.setText("Capturar pagos manualmente");
        moRadInputManual.setPreferredSize(new java.awt.Dimension(255, 23));
        jPanel22.add(moRadInputManual);

        bgInput.add(moRadInputChoosingPayments);
        moRadInputChoosingPayments.setText("Capturar mediante solicitudes de pago");
        moRadInputChoosingPayments.setPreferredSize(new java.awt.Dimension(255, 23));
        jPanel22.add(moRadInputChoosingPayments);

        jpLayoutC.add(jPanel22);
        ...
        jbGridRowsAddPayments.setText("Agregar pagos");
        jbGridRowsAddPayments.setMargin(new java.awt.Insets(2, 0, 2, 0));
        jbGridRowsAddPayments.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel21.add(jbGridRowsAddPayments);

        jbGridRowsClearPayments.setText("Eliminar pagos");
        jbGridRowsClearPayments.setMargin(new java.awt.Insets(2, 0, 2, 0));
        jbGridRowsClearPayments.setPreferredSize(new java.awt.Dimension(125, 23));
        jPanel21.add(jbGridRowsClearPayments);

        jpLayoutC.add(jPanel21);

        jpLayout.add(jpLayoutC, java.awt.BorderLayout.CENTER);

        getContentPane().add(jpLayout, java.awt.BorderLayout.NORTH);

        jpSettings.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalle del layout:"));
    ...
    private javax.swing.JButton jbGridRowsAddPayments;
    private javax.swing.JButton jbGridRowsClear;
    private javax.swing.JButton jbGridRowsClearPayments;
    ...
    private javax.swing.JPanel jpLayoutC;
    private javax.swing.JPanel jpLayoutW;
    ...
    private void initComponentsCustom() {
        ...
        switch (mnFormSubtype) {
            ...
            default:
                miClient.showMsgBoxError(SLibConsts.ERR_MSG_OPTION_UNKNOWN + "\n(Subtipo de forma: " + mnFormSubtype + ")");
        }

        moBoolShowOnlyDocsDueDate = new SBeanFieldBoolean();
        ...
        jbGridRowsUncheckAll.setToolTipText("Seleccionar nada");
            ...
            for (SGridRow gridRow : moGridPayments.getModel().getGridRows()) {
                ...
                if (layoutBankPaymentRow.isForPayment()) {
                    ...
                    for (Integer iPayment : layoutBankPaymentRow.getPaymentIds()) {
                        ...
                        oPayment.read(miClient.getSession(), new int[]{iPayment});
    ...
    private void populateGridWithDocsFromDb(final boolean showValidationOfExistingRows) {
        ...
        try {
            ...
            if (moRadDocuments.isSelected()) {
                sql = "SELECT b.id_bp, b.bp, b.fiscal_id, d.exc_rate AS f_ext_rate, bct.bp_key, bpb_con.email_01, cob.code AS cob_code, " +
                ...
                sql += "SELECT  " +
                        ...
                        "            d.num) AS f_num, " +
                        "    d.stot_r AS f_stot, " +
                        "    d.stot_cur_r AS f_stot_cur, " +
                        "    d.tax_charged_r AS f_tax, " +
                        "    d.tax_charged_cur_r AS f_tax_cur, " +
                        "    d.tax_retained_r AS f_ret, " +
                        "    d.tax_retained_cur_r AS f_ret_cur, " +
                        "    d.tot_r AS f_tot, " +
                        "    d.tot_cur_r AS f_tot_cur, " +
                        "    d.fid_bpb, " +
                        "    dt.code, " +
                        "    c.id_cur AS f_id_cur, " +
                        "    c.cur_key, " +
                        "    COALESCE(pay._payed, 0) AS f_payed, " +
                        "    COALESCE(pay._payed_cur, 0) AS f_payed_cur, " +
                        "    (d.tot_r - COALESCE(pay._payed, 0)) AS f_bal, " +
                        "    (d.tot_cur_r - COALESCE(pay._payed_cur, 0)) AS f_bal_cur, " +
                        "    COALESCE((SELECT  " +
                        "                    SUM(tax.tax) " +
                        "                FROM " +
                        "                    trn_dps_ety AS de " +
                        "                        INNER JOIN " +
                        "                    trn_dps_ety_tax AS tax ON de.id_year = tax.id_year " +
                        "                        AND de.id_doc = tax.id_doc " +
                        "                        AND de.id_ety = tax.id_ety " +
                        "                        AND tax.id_tax_bas = " + SDataConstantsSys.FINU_TAX_BAS_VAT + " " +
                        "                WHERE " +
                        "                    d.id_year = de.id_year " +
                        ...
                        "                        AND de.b_del = 0), " +
                        "            0) AS f_iva_cur, " +
                        "    ADDDATE(d.dt_start_cred, d.days_cred) AS dt_mat, " +
                        "    x.uuid AS xml_uuid, " +
                        "    x.xml_rfc_emi, " +
                        "    x.xml_rfc_rec, " +
                        "    x.xml_tot, " +
                        "    x.fid_tp_cfd AS xml_type, " +
                        "    cx.doc_xml " +
                        "FROM " +
                        "    trn_dps AS d " +
                        "        INNER JOIN " +
                        "    erp.bpsu_bp AS b ON d.fid_bp_r = b.id_bp AND d.b_del = 0 " +
                        "        AND d.fid_st_dps = " + SDataConstantsSys.TRNS_ST_DPS_EMITED + " " +
                        "        AND d.id_year = " + SLibTimeUtils.digestYear(moDateDateDue.getValue())[0] + " " +
                        "        INNER JOIN " +
                        "    erp.bpsu_bp_ct AS bct ON d.fid_bp_r = bct.id_bp " +
                        "        INNER JOIN " +
                        ...
                        "        INNER JOIN " +
                        "    erp.cfgu_cur AS c ON d.fid_cur = c.id_cur AND d.fid_cur = " + mnDpsCurrencyId + " " +
                        "        INNER JOIN " +
                        ...
                        "        LEFT OUTER JOIN " +
                        "    trn_cfd AS x ON d.id_year = x.fid_dps_year_n " +
                        "        AND d.id_doc = x.fid_dps_doc_n " +
                        "        LEFT OUTER JOIN " +
                        "    " + SClientUtils.getComplementaryDdName((SClientInterface) miClient) + ".trn_cfd AS cx ON x.id_cfd = cx.id_cfd " +
                        "        LEFT JOIN " +
                        "    (SELECT  " +
                        "        pre.fk_doc_year_n, " +
                        "        pre.fk_doc_doc_n, " +
                        "        SUM(ety_pay) AS _payed, " +
                        "        SUM(des_pay_app_ety_cur) AS _payed_cur " +
                        "    FROM " +
                        "        fin_pay AS pr " +
                        "    INNER JOIN fin_pay_ety AS pre ON pr.id_pay = pre.id_pay ";
                if (moRegistry.getPkBankLayoutId() > 0) {
                    sql += "INNER JOIN fin_pay_lay_bank AS plb ON pr.id_pay = plb.id_pay "
                                    + "AND plb.id_lay_bank <> " + moRegistry.getPkBankLayoutId() + " " +
                    ...
                    sql += "    WHERE " +
                        ...
                        "            AND pr.fk_st_pay IN (" + 
                                            ...
                                            ") " +
                        "    GROUP BY pre.fk_doc_year_n , pre.fk_doc_doc_n) AS pay ON d.id_year = pay.fk_doc_year_n " +
                        "        AND d.id_doc = pay.fk_doc_doc_n " +
                        "WHERE " +
                        "    EXISTS(SELECT  " +
                        "            1 " +
                        "        FROM " +
            ...
            try (ResultSet resulSet = miClient.getSession().getStatement().executeQuery(sql)) {
                while (resulSet.next()) {
                    ...
                    layoutBankRow.setMoneyDpsBalance(new SMoney(miClient.getSession(), 
                                                        resulSet.getDouble("f_bal_cur"), 
                                                        resulSet.getInt("f_id_cur"), 
                                                        resulSet.getDouble("f_ext_rate")));
    ...
    private void actionPerformedGridRowsAddPayments() {
        ...
        if (moPickerPayments.getFormResult() == SGuiConsts.FORM_RESULT_OK) {
            ...
            if (cantWarn > 0) {
                SDialogShowImportErrors errors = new SDialogShowImportErrors("", warn, 0, cantWarn);
    ...
    private void actionPerformedGridRowsClearPayments() {
...
//            miClient.showMsgBoxWarning(SGridConsts.MSG_SELECT_GRID_ROW);
                            ...
                            for (SLayoutBankRow layoutBankRowInArray : maAllLayoutBankRows) {
                                if (SLibUtils.compareKeys(key, new int[] { layoutBankRowInArray.getDpsDocId(), layoutBankRowInArray.getDpsYearId() }) || SLibUtils.compareKeys(key, new int[] { layoutBankRowInArray.getBizPartnerId() })) {
                                    ...
                                    try {
                                        ...
                                        if (idPayment > 0) {
                                            SRowPayments oPaymentRow = SPaymentUtils.readPayment(miClient.getSession().getStatement().getConnection(), idPayment);
                                    ...
                                    double amount = idPayment == 0
                                            ? (double) xmlBankLayoutPayment.getAttribute(SXmlBankLayoutPayment.ATT_LAY_PAY_AMT_CY).getValue()
                                            : (double) xmlBankLayoutPaymentDoc.getAttribute(SXmlBankLayoutPaymentDoc.ATT_LAY_ROW_AMT_CY).getValue();
                                    layoutBankRowInArray.getMoneyPayment().setOriginalAmount(
                                            layoutBankRowInArray.getMoneyPayment().getOriginalAmount() + amount);
    ...
    private void enableFieldsForm(boolean enable) {
        switch (mnFormSubtype) {
            ...
            case SModSysConsts.FINX_LAY_BANK_TRN_TP_PREPAY:
                ...
                jbGridRowsAddPayments.setEnabled(!enable && moRadInputChoosingPayments.getValue());
                jbGridRowsClearPayments.setEnabled(!enable && moRadInputChoosingPayments.getValue());
                break;
    ...
    private void enableFieldsGrid(final boolean enableFields) {
        ...
        jbGridRowsCheckAll.setEnabled(enableFields && isModeForTransfersOfPayments() && moRadInputManual.getValue());
        jbGridRowsUncheckAll.setEnabled(enableFields && isModeForTransfersOfPayments() && moRadInputManual.getValue());
    ...
    private void itemStateChangedShowOnlyBenefsWithAccounts() {
        if (moBoolShowOnlyBenefsWithAccounts.isEnabled()) {
            refreshGridRows();
        }
    }
    ...
    * @return Cadena vacía si no hay errores, de lo contrario el mensaje conteniendo los errores encontrados.
    ...
    public void addAllListeners() {
        ...
        jbGridRowsAddPayments.addActionListener(this);
        jbGridRowsClearPayments.addActionListener(this);
    ...
    public void removeAllListeners() {
        ...
        jbGridRowsAddPayments.removeActionListener(this);
        jbGridRowsClearPayments.removeActionListener(this);
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        ...
        if (moRegistry.isRegistryNew()) {
            ...
            bgDocOpType.setSelected(moRegistry.getLayoutOperationType().equals(SDbPayment.OPERATION_TYPE_DOC_ADVANCE) ? 
        ...
        moBoolShowOnlyDocsDueDate.setSelected(false);
        moBoolShowOnlyBenefsWithAccounts.setSelected(isModeForTransfers());
        ...
        */
        ...
        if (moRegistry.isRegistryNew()) {
            ...
            bgInput.setSelected(moRegistry.getAuxNewPayments().isEmpty() ? 
                                                moRadInputManual.getModel() : 
                                                moRadInputChoosingPayments.getModel(), 
                                                true);
    ...
    public SDbBankLayout getRegistry() throws Exception {
        ...
        if (isModeForTransfers()) {
            ...
            registry.setLayoutOperationType(moRadAdvanceDocuments.isSelected() ? 
                                            SDbPayment.OPERATION_TYPE_DOC_ADVANCE : 
                                            SDbPayment.OPERATION_TYPE_NORMAL);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() instanceof JButton) {
            ...
            else if (button == jbGridRowsAddPayments) {
                actionPerformedGridRowsAddPayments();
            }
            else if (button == jbGridRowsClearPayments) {
                actionPerformedGridRowsClearPayments();
            }
