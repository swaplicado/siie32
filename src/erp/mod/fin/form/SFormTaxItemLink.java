 ...
 * @author Juan Barajas
 */
public class SFormTaxItemLink extends sa.lib.gui.bean.SBeanForm {

    private SDbTaxItemLink moRegistry;
    
    /**
     * Creates new form SFormTaxItemLink
     */
    public SFormTaxItemLink(SGuiClient client, String title) {
    ...
    private void initComponents() {
        ...
        moKeyTaxRegion = new sa.lib.gui.bean.SBeanFieldKey();
        jPanel26 = new javax.swing.JPanel();
        jlTaxGroup = new javax.swing.JLabel();
        moKeyTaxGroup = new sa.lib.gui.bean.SBeanFieldKey();
        ...
        jlTaxRegion.setText("Región impuesto: *");
        jlTaxRegion.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel25.add(jlTaxRegion);

        moKeyTaxRegion.setPreferredSize(new java.awt.Dimension(300, 23));
        jPanel25.add(moKeyTaxRegion);

        jPanel23.add(jPanel25);

        jPanel26.setLayout(new java.awt.FlowLayout(0, 5, 0));

        jlTaxGroup.setText("Grupo impuesto: *");
        jlTaxGroup.setPreferredSize(new java.awt.Dimension(100, 23));
        jPanel26.add(jlTaxGroup);

        moKeyTaxGroup.setPreferredSize(new java.awt.Dimension(300, 23));
        jPanel26.add(moKeyTaxGroup);
    ...
    private sa.lib.gui.bean.SBeanFieldKey moKeyTaxGroup;
    private sa.lib.gui.bean.SBeanFieldKey moKeyTaxRegion;
    ...
    private void initComponentsCustom() {
        ...
        moKeyTaxRegion.setKeySettings(miClient, SGuiUtils.getLabelName(jlTaxRegion.getText()), true);
        moKeyTaxGroup.setKeySettings(miClient, SGuiUtils.getLabelName(jlTaxGroup.getText()), true);
    ...
    public void reloadCatalogues() {
        miClient.getSession().populateCatalogue(moKeyTaxRegion, SModConsts.FINU_TAX_REG, SLibConsts.UNDEFINED, null);
        miClient.getSession().populateCatalogue(moKeyTaxGroup, SModConsts.FIN_TAX_GRP, SLibConsts.UNDEFINED, null);
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        int[] key = null;
        moRegistry = (SDbTaxItemLink) registry;
        ...
        moKeyLink.setValue(new int[] { key[0] });
        moKeyReference.setValue(new int[] { key[1] });
        moKeyTaxRegion.setValue(new int[] {  moRegistry.getFkTaxRegionId() });
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbTaxItemLink registry = moRegistry.clone();
        ...
        moRegistry.setFkTaxRegionId(moKeyTaxRegion.getValue()[0]);
        moRegistry.setFkTaxGroupId(moKeyTaxGroup.getValue()[0]);
