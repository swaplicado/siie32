 ...
 * @author Juan Barajas
 */
public class SFormAbpItemLink extends sa.lib.gui.bean.SBeanForm {

    private SDbAbpItemLink moRegistry;
    
    /**
     * Creates new form SFormAbpItemLink
     */
    public SFormAbpItemLink(SGuiClient client, String title) {
    ...
    public void reloadCatalogues() {
        miClient.getSession().populateCatalogue(moKeyAbp, SModConsts.FIN_ABP_ITEM, SLibConsts.UNDEFINED, null);
    ...
    public void setRegistry(SDbRegistry registry) throws Exception {
        int[] key = null;
        moRegistry = (SDbAbpItemLink) registry;
    ...
    public SDbRegistry getRegistry() throws Exception {
        SDbAbpItemLink registry = moRegistry.clone();
        
        if (registry.isRegistryNew()) {}
        
        moRegistry.setPkAbpItemId(moKeyAbp.getValue()[0]);
