...
/*
 * SDialogRepAccountingAux.java
 *
 * Created on 7/05/2010, 04:35:16 PM
 */
 ...
 */
public class SDialogRepAccountingAux extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener, java.awt.event.FocusListener {
    ...
    private void initComponents() {
        ...
        setTitle("Reporte auxiliares de contabilidad");
        setResizable(false);
        ...
        jPanel9.add(jckShowRecordAdjYearEnd);
        ...
        setBounds((screenSize.width-720)/2, (screenSize.height-450)/2, 720, 450);
    ...
    private void actionPrint() {
        ...
        if (validation.getIsError()) {
            ...
            try {
                ...
                map.put("sSqlOrderBy", miClient.getSessionXXX().getParamsErp().getFkSortingItemTypeId() == SDataConstantsSys.CFGS_TP_SORT_KEY_NAME ?
                    "ORDER BY i.item_key, i.item, i.id_item " : "ORDER BY i.item, i.item_key, i.id_item ");
                map.put("sSqlFieldsMayor", ", am.deep, am.fid_tp_acc_sys ");
                ...
                jasperPrint = SDataUtilities.fillReport(miClient, SDataConstantsSys.REP_FIN_AUX_ACC, map);
                jasperViewer = new JasperViewer(jasperPrint, false);
                jasperViewer.setTitle("Reporte auxiliar contable");
    ...
    private java.lang.String createParamSql() {
        ...
        for (int i = 1; i <= miClient.getSessionXXX().getParamsErp().getDeepAccounts(); i++) {
            ...
            sql += (sql.length() == 0 ? "" : "UNION ") +
                    "SELECT COUNT(*) AS cont, CONCAT(LEFT(re.fid_acc, " + len + "), '" + account.substring(len) + "')" + " AS f_id_acc, " +
    ...
    public erp.lib.form.SFormValidation formValidate() {
        ...
        if (!validation.getIsError()) {
            if (moPanelAccountInitial.getFieldAccount().getString().compareTo(moPanelAccountEnd.getFieldAccount().getString()) > 0) {
