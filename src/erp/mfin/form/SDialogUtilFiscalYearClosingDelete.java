 ...
 * @author Juan Barajas
 */
public class SDialogUtilFiscalYearClosingDelete extends javax.swing.JDialog {
    ...
    public SDialogUtilFiscalYearClosingDelete(erp.client.SClientInterface client) {
    ...
    private void initComponents() {
        ...
        setTitle("Eliminación de cierre del ejercicio");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Parámetros de eliminación de cierre del ejercicio:"));
        ...
        jlYear.setText("Ejercicio para el que se eliminará el cierre del ejercicio: *");
        ...
        setBounds((screenSize.width-368)/2, (screenSize.height-238)/2, 368, 238);
        ...
        if (moFieldYear.validateField()) {
            if (!SDataUtilities.isPeriodOpen(miClient, new int[] { moFieldYear.getInteger(), 12 })) {
                ...
                try {
                    ...
                    msPkRecordTypeId = SDataConstantsSys.FINU_TP_REC_FY_END;
                    mnPkNumberId = 1;
