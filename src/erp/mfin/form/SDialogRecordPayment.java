...
public class SDialogRecordPayment extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener, java.awt.event.FocusListener {
    ...
    private void initComponents() {
        ...
        jtfCompanyBranchRo.setPreferredSize(new java.awt.Dimension(125, 23));
        ...
        jtfAccountCashCurRo.setPreferredSize(new java.awt.Dimension(125, 23));
        ...
        jcbFkCheckId_n.setPreferredSize(new java.awt.Dimension(275, 23));
        ...
        jckIsExchangeRatePreserverd.setText("Conservar tipo de cambio");
    ...
    public erp.lib.data.SDataRegistry getRegistry() {
        ...
        SDataBizPartnerBranch branch = null;
        ArrayList<SBalanceTax> balances = SMfinUtils.getBalanceByTax(miClient.getSession().getDatabase().getConnection(), moDps.getPkDocId(), miClient.getSession().getCurrentYear(), 
