...
public class SViewRecord extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT r.id_year, r.id_per, r.id_bkc, r.id_tp_rec, r.id_num, " +
                ...
                "(SELECT COUNT(id_cfd) FROM trn_cfd AS c WHERE re.id_year = c.fid_rec_year_n AND re.id_per = c.fid_rec_per_n AND re.id_bkc = c.fid_rec_bkc_n AND re.id_tp_rec = c.fid_rec_tp_rec_n AND re.id_num = c.fid_rec_num_n) AS cfd " +
                "FROM fin_rec AS r " +
