 ...
 */
public class SViewAccountItem extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private javax.swing.JButton jbCopy;
    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewAccountItem(erp.client.SClientInterface client, java.lang.String tabTitle) {
        super(client, tabTitle, SDataConstants.FIN_ACC_ITEM);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        i = 0;
        aoKeyFields[i++] = new STableField(SLibConstants.DATA_TYPE_INTEGER, "a.id_acc_item");
        for (i = 0; i < aoKeyFields.length; i++) {
            moTablePane.getPrimaryKeyFields().add(aoKeyFields[i]);
        }

        i = 0;
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "a.acc_item", "Paquete configuración", STableConstants.WIDTH_ACCOUNT);
        ...
        mvSuscriptors.add(SDataConstants.FINX_ACC_ITEM_QRY);
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT a.id_acc_item, a.acc_item, a.b_del, " +
                "a.ts_new, a.ts_edit, a.ts_del, un.usr, ue.usr, ud.usr " +
                "FROM fin_acc_item AS a " +
                ...
                "ORDER BY a.acc_item, a.id_acc_item ";
    }
