 ...
 */
public class SViewAccountCashCash extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewAccountCashCash(erp.client.SClientInterface client, java.lang.String tabTitle) {
        super(client, tabTitle, SDataConstants.FINX_ACC_CASH_CASH);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "e.ent", "Caja", 200);
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT ac.id_cob, ac.id_acc_cash, e.ent, e.code, ac.b_del, ac.fid_acc, f_acc_usr(" + ((SDataParamsCompany) miClient.getSession().getConfigCompany()).getMaskAccount() + ", a.code) AS f_acc, " +
                ...
                "WHERE cob.fid_bp = " + miClient.getSessionXXX().getCurrentCompany().getPkCompanyId() + " AND ac.fid_ct_acc_cash = " + SDataConstantsSys.FINS_CT_ACC_CASH_CASH + " " +
