 ...
 */
public class SProcYearVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcYearVal() {
        super(SProcConstants.FIN_YEAR_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_year_val(?, ?) }");
