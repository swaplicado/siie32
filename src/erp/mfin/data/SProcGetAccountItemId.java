 ...
 */
public class SProcGetAccountItemId extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetAccountItemId() {
        super(SProcConstants.FIN_ACC_ITEM);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_get_acc_item(?, ?, ?, ?, ?) }");
