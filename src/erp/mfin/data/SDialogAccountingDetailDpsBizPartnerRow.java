 ...
 */
public class SDialogAccountingDetailDpsBizPartnerRow extends erp.lib.table.STableRow {
    ...
    protected double mdDebitCurrency;
    protected double mdCreditCurrency;
    protected double mdBalanceCurrency;
    ...
    public SDialogAccountingDetailDpsBizPartnerRow(erp.client.SClientInterface client) {
        miClient = client;
        reset();
    }
    ...
    public void setDebitCurrency(double d) { mdDebitCurrency = d; }
    public void setCreditCurrency(double d) { mdCreditCurrency = d; }
    public void setBalanceCurrency(double d) { mdBalanceCurrency = d; }
    ...
    public double getDebitCurrency() { return mdDebitCurrency; }
    public double getCreditCurrency() { return mdCreditCurrency; }
    public double getBalanceCurrency() { return mdBalanceCurrency; }
    ...
    public void prepareTableRow() {
        ...
        mvValues.add(mdDebitCurrency);
        mvValues.add(mdCreditCurrency);
        mvValues.add(mdBalanceCurrency);
        ...
        mvValues.add(mbIsExchangeDifference);
