 ...
 */
public class SProcAccountBizPartnerBpTypeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcAccountBizPartnerBpTypeVal() {
        super(SProcConstants.FIN_ACC_BP_TP_BP_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_acc_bp_tp_bp_val(?, ?, ?, ?, ?, ?) }");
