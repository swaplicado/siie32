 ...
 */
public class SProcAccountRecordVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcAccountRecordVal() {
        super(SProcConstants.FIN_ACC_REC_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_acc_rec_val(?, ?) }");
