 ...
 */
public class SProcCheckNumberVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcCheckNumberVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_check_num_val(?, ?, ?, ?) }");
