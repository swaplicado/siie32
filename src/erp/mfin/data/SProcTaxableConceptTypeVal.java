 ...
 */
public class SProcTaxableConceptTypeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcTaxableConceptTypeVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.finu_tp_tax_cpt_val(?, ?, ?) }");
