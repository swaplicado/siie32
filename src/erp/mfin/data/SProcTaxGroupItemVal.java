 ...
 */
public class SProcTaxGroupItemVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcTaxGroupItemVal() {
        super(SProcConstants.FIN_TAX_GRP_ITEM_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_tax_grp_item_val(?, ?) }");
