 ...
 */
public class SProcGetCheckWalletCount extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetCheckWalletCount() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_get_check_wal_count(?, ?, ?, ?) }");
