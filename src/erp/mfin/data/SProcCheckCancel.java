 ...
 */
public class SProcCheckCancel extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcCheckCancel() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_check_cancel(?, ?, ?, ?, ?, ?) }");
