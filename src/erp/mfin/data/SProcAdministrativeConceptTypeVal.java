 ...
 */
public class SProcAdministrativeConceptTypeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcAdministrativeConceptTypeVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.finu_tp_adm_cpt_val(?, ?, ?) }");
