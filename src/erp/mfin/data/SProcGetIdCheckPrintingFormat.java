 ...
 */
public class SProcGetIdCheckPrintingFormat extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetIdCheckPrintingFormat() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_get_id_check_fmt(?, ?, ?) }");
