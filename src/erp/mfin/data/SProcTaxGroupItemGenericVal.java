 ...
 */
public class SProcTaxGroupItemGenericVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcTaxGroupItemGenericVal() {
        super(SProcConstants.FIN_TAX_GRP_IGEN_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_tax_grp_igen_val(?, ?) }");
