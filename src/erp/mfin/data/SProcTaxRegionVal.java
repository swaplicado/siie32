 ...
 */
public class SProcTaxRegionVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcTaxRegionVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.finu_tax_reg_val(?, ?, ?) }");
