 ...
 */
public class SProcGetCheckNextNumber extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetCheckNextNumber() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_get_check_next_num(?, ?) }");
