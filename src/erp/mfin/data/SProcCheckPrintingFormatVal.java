 ...
 */
public class SProcCheckPrintingFormatVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcCheckPrintingFormatVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.finu_check_fmt_val(?, ?, ?) }");
