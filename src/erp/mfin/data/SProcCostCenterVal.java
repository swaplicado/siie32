 ...
 */
public class SProcCostCenterVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcCostCenterVal() {
        super(SProcConstants.FIN_CC_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_cc_val(?, ?) }");
