                        ...
                        if (isDebit) {
                            ...
                            if (debit > 0 || credit < 0 || (debit == 0 && credit == 0)) {
                                    ...
                                    switch (vat.getVatType()) {
                                        case SDiotConsts.VAT_TYPE_EXEMPT:
                                            if (tercero.IsDomestic) {
                                                tercero.XValorPagosNacIvaExento = SLibUtils.roundAmount(tercero.XValorPagosNacIvaExento + transactionAmount);
                                            }
                                            else {
                                                tercero.XValorPagosImpIvaExento = SLibUtils.roundAmount(tercero.XValorPagosImpIvaExento + transactionAmount);
                                            }
                                            break;
                                        ...
                                        case SDiotConsts.VAT_TYPE_BORDER_NORTH: // VAT deliberately manipulated to be zero
                                            tercero.XValorPagosNacIva0 = SLibUtils.roundAmount(tercero.XValorPagosNacIva0 + transactionAmount);
                                            break;
                                        ...
                                        if (vatProcessed >= vatAmount) {
                                            if (terceroExempt != 0) {
                                                if (terceroToProcess.IsDomestic) {
                                                    terceroToProcess.XValorPagosNacIvaExento = SLibUtils.roundAmount(terceroToProcess.XValorPagosNacIvaExento + terceroExempt);
                                                }
                                                else {
                                                    terceroToProcess.XValorPagosImpIvaExento = SLibUtils.roundAmount(terceroToProcess.XValorPagosImpIvaExento + terceroExempt);
                                                }
                                            }
                                            ...
                                            if (terceroToProcess == tercero) {
                                                ...
                                                if (netSubtotalCalcDiff < -AMOUNT_DIFF_ALLOWANCE) {
                                                    ...
                                                    if (terceroToProcess.IsDomestic) {
                                                        terceroToProcess.XValorPagosNacIvaExento = SLibUtils.roundAmount(terceroToProcess.XValorPagosNacIvaExento + netSubtotalCalcDiff);
                                                    }
                                                    else {
                                                        terceroToProcess.XValorPagosImpIvaExento = SLibUtils.roundAmount(terceroToProcess.XValorPagosImpIvaExento + netSubtotalCalcDiff);
                                                    }
                                                }
                                            ...
                                            switch (vat.getVatType()) {
                                                case SDiotConsts.VAT_TYPE_GENERAL:
                                                    if (terceroToProcess.IsDomestic) {
                                                        terceroToProcess.XValorPagosNacIva1516 = SLibUtils.roundAmount(terceroToProcess.XValorPagosNacIva1516 + netSubtotalCalc);
                                                    }
                                                    else {
                                                        terceroToProcess.XValorPagosImpIva1516 = SLibUtils.roundAmount(terceroToProcess.XValorPagosImpIva1516 + netSubtotalCalc);
                                                    }
                                                    break;

                                                case SDiotConsts.VAT_TYPE_BORDER:
                                                    if (terceroToProcess.IsDomestic) {
                                                        terceroToProcess.XValorPagosNacIva1011 = SLibUtils.roundAmount(terceroToProcess.XValorPagosNacIva1011 + netSubtotalCalc);
                                                    }
                                                    else {
                                                        terceroToProcess.XValorPagosImpIva1011 = SLibUtils.roundAmount(terceroToProcess.XValorPagosImpIva1011 + netSubtotalCalc);
                                                    }
                                                    break;

                                                case SDiotConsts.VAT_TYPE_BORDER_NORTH:
                                                    terceroToProcess.XValorPagosNacIvaEstFront = SLibUtils.roundAmount(terceroToProcess.XValorPagosNacIvaEstFront + netSubtotalCalc);
                                                    break;
                                ...
                                if (tercero.IsGlobal) {
                                    ...
                                    tercero.XIvaNotasCréditoCompras = SLibUtils.roundAmount(tercero.XIvaNotasCréditoCompras + vatAmount);
                                }
                            }
                        }
                        else if (isCredit) {
                            ...
                            if (debit < 0 || credit > 0 || (debit == 0 && credit == 0)) {
                                ...
                                tercero.XIvaRetenido = SLibUtils.roundAmount(tercero.XIvaRetenido + vatAmount);
        ...
        for (SDiotTercero tercero : terceros) {
            ...
            if (tercero.IsGlobal) {
                if (terceroCompany == null) {
                    ...
                    throw new Exception("Al menos existen dos terceros que corresponden a esta empresa (" + tercero.TerRfc + ").");
                }
            }
            else {
