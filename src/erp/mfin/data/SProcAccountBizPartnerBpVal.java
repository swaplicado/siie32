 ...
 */
public class SProcAccountBizPartnerBpVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcAccountBizPartnerBpVal() {
        super(SProcConstants.FIN_ACC_BP_BP_VAL);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_acc_bp_bp_val(?, ?, ?, ?, ?, ?) }");
