 ...
 */
public class SProcGetCompanyBranchBookKeepingCenterId extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcGetCompanyBranchBookKeepingCenterId() {
        super(SProcConstants.FIN_COB_BKC);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL fin_get_cob_bkc(?, ?) }");
