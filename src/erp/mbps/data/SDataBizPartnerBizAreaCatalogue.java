 ...
 */
public class SDataBizPartnerBizAreaCatalogue extends erp.lib.data.SDataRegistry implements java.io.Serializable {

    protected int mnPkBizAreaId;
    protected java.lang.String msBizArea;
    ...
    public SDataBizPartnerBizAreaCatalogue() {
        super(SDataConstants.BPSU_BA);
        reset();
    }

    public void setPkBizAreaId(int n) { mnPkBizAreaId = n; }
    public void setBizArea(java.lang.String s) { msBizArea = s; }
    ...
    public java.lang.String getBizArea() { return msBizArea; }
    ...
    public void setPrimaryKey(java.lang.Object pk) {
        mnPkBizAreaId = ((int[]) pk)[0];
    }

    @Override
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkBizAreaId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM erp.bpsu_ba WHERE id_ba = " + key[0] + " ";
            ...
            if (!resultSet.next()) {
                ...
                msBizArea = resultSet.getString("ba");
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall(
                    "{ CALL erp.bpsu_ba_save(" +
                    "?, ?, ?, ?, ?, ?, ?, ?, ?) }");
            callableStatement.setInt(nParam++, mnPkBizAreaId);
            callableStatement.setString(nParam++, msBizArea);
            ...
            mnPkBizAreaId = callableStatement.getInt(nParam - 3);
