 ...
 */
public class SProcBizPartnerVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcBizPartnerVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.bpsu_bp_val(?, ?, ?) }");
