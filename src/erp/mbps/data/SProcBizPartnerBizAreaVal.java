 ...
 */
public class SProcBizPartnerBizAreaVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcBizPartnerBizAreaVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.bpsu_ba_val(?, ?, ?) }");
