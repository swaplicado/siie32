 ...
 */
public class SDataBizPartnerBranchNote extends erp.lib.data.SDataRegistry implements java.io.Serializable {

    protected int mnPkBizPartnerBranchId;
    protected int mnPkNotesId;
    protected java.lang.String msNotes;

    public SDataBizPartnerBranchNote() {
    ...
    public java.lang.Object getPrimaryKey() {
        return new int[] { mnPkBizPartnerBranchId, mnPkNotesId };
    }
    ...
    public int read(java.lang.Object pk, java.sql.Statement statement) {
        ...
        try {
            sql = "SELECT * FROM erp.bpsu_bpb_nts WHERE id_bpb = " + key[0] + " AND id_nts = " + key[1] + " ";
    ...
    public int save(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.bpsu_bpb_nts_save(?, ?, ?, ?, ?, ?) }");
