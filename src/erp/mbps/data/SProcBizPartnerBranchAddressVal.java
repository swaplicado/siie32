 ...
 */
public class SProcBizPartnerBranchAddressVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcBizPartnerBranchAddressVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.bpsu_bpb_add_val(?, ?, ?, ?) }");
