 ...
 */
public class STabFilterTax extends javax.swing.JPanel {
    ...
    public STabFilterTax(erp.lib.table.STableTabInterface tableTab) {
        miTableTab = tableTab;
        initComponents();
        initComponentsExtra();
    }
    ...
    private void initComponents() {
        ...
        jtbFilter.setToolTipText("Filtrar impuestos");
    ...
    private void initComponentsExtra() {
        moSetting = new STableSetting(STableConstants.SETTING_OPTION_TAXES, STableConstants.STATUS_ON);
