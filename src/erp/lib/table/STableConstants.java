...
public abstract class STableConstants {
    ...
    public static final int WIDTH_VALUE_3X = 125;
    ...
    public static final int WIDTH_QUANTITY = 75;
    public static final int WIDTH_QUANTITY_2X = 100;
    public static final int WIDTH_QUANTITY_3X = 125;
    ...
    public static final int WIDTH_ITEM = 80;
