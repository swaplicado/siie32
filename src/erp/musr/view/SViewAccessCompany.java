 ...
 */
public class SViewAccessCompany extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewAccessCompany(erp.client.SClientInterface client, java.lang.String tabTitle) {
        super(client, tabTitle, SDataConstants.USRU_ACCESS_CO);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        aoKeyFields[i++] = new STableField(SLibConstants.DATA_TYPE_INTEGER, "a.id_co");
    ...
    public void createSqlQuery() {
        ...
        for (int i = 0; i < mvTableSettings.size(); i++) {
            ...
            if (setting.getType() == STableConstants.SETTING_FILTER_DELETED && setting.getStatus() == STableConstants.STATUS_ON) {
                sqlWhere += (sqlWhere.length() == 0 ? "" : "AND ") + "(u.b_del = FALSE AND c.b_del = FALSE) ";
            }
        }

        msSql = "SELECT a.id_usr, a.id_co, a.b_univ, a.b_def, " +
                "u.usr, u.b_del, c.co, c.b_del " +
                "FROM erp.usru_access_co AS a " +
                "INNER JOIN erp.usru_usr AS u ON " +
                "a.id_usr = u.id_usr " +
                "INNER JOIN erp.cfgu_co AS c ON " +
                "a.id_co = c.id_co " +
                (sqlWhere.length() == 0 ? "" : "WHERE " + sqlWhere) +
                "ORDER BY c.co, a.id_co, u.usr, a.id_usr ";
    }
