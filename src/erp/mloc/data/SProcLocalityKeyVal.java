 ...
 */
public class SProcLocalityKeyVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcLocalityKeyVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.locu_loc_key_val(?, ?, ?) }");
