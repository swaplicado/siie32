 ...
 */
public class SFormMaterialAttribute extends javax.swing.JDialog implements erp.lib.form.SFormInterface, java.awt.event.ActionListener {
    ...
    public void setRegistry(erp.lib.data.SDataRegistry registry) {
        ...
        if (moMaterialAttribute.isIsCanDelete()) {
    ...
    public erp.lib.data.SDataRegistry getRegistry() {
        if (moMaterialAttribute == null) {
            ...
            moMaterialAttribute.setFkUserUpdateId(miClient.getSession().getUser().getPkUserId());
        }

        moMaterialAttribute.setName(moFieldName.getString());
        moMaterialAttribute.setIsCanEdit(true);
        moMaterialAttribute.setIsCanDelete(true);
        moMaterialAttribute.setIsDeleted(moFieldIsDeleted.getBoolean());

        return moMaterialAttribute;
    }
