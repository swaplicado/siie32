 ...
 */
public class SProcBrandTypeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcBrandTypeVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_tp_brd_val(?, ?, ?) }");
