 ...
 */
public class SProcBrandVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcBrandVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_brd_val(?, ?, ?, ?) }");
