 ...
 */
public class SProcUnitVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_unit_val(?, ?, ?, ?) }");
