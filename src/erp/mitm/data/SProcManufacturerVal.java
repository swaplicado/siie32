 ...
 */
public class SProcManufacturerVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcManufacturerVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_mfr_val(?, ?, ?, ?) }");
