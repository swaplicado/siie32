 ...
 */
public class SProcItemFamilyVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcItemFamilyVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_ifam_val(?, ?, ?) }");
