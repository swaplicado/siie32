 ...
 */
public class SProcUnitTypeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcUnitTypeVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_tp_unit_val(?, ?, ?) }");
