 ...
 */
public class SProcElementVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcElementVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_emt_val(?, ?, ?, ?) }");
