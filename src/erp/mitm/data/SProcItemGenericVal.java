 ...
 */
public class SProcItemGenericVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcItemGenericVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_igen_val(?, ?, ?) }");
