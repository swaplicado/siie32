 ...
 */
public class SProcItemGroupVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcItemGroupVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_igrp_val(?, ?, ?, ?) }");
