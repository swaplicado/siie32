 ...
 */
public class SProcItemBarcodeVal extends erp.lib.data.SDataProcedure implements java.io.Serializable {

    public SProcItemBarcodeVal() {
        super(0);
    }
    ...
    public int call(java.sql.Connection connection) {
        ...
        try {
            callableStatement = connection.prepareCall("{ CALL erp.itmu_item_barc_val(?, ?, ?) }");
