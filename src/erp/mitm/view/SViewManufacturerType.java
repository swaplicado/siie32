 ...
 */
public class SViewManufacturerType extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewManufacturerType(erp.client.SClientInterface client, java.lang.String tabTitle) {
        super(client, tabTitle, SDataConstants.ITMU_TP_MFR);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        i = 0;
        aoKeyFields[i++] = new STableField(SLibConstants.DATA_TYPE_INTEGER, "t.id_tp_mfr");
        for (i = 0; i < aoKeyFields.length; i++) {
            moTablePane.getPrimaryKeyFields().add(aoKeyFields[i]);
        }

        i = 0;
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "t.tp_mfr", "Tipo fabricante", 300);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_BOOLEAN, "t.b_can_edit", "Modificable", STableConstants.WIDTH_BOOLEAN_2X);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_BOOLEAN, "t.b_can_del", "Eliminable", STableConstants.WIDTH_BOOLEAN_2X);
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT t.id_tp_mfr, t.tp_mfr, t.b_can_edit, t.b_can_del, t.b_del, " +
                "t.b_can_edit AS " + STableConstants.FIELD_IS_EDITABLE + ", " +
                "t.ts_new, t.ts_edit, t.ts_del, un.usr, ue.usr, ud.usr " +
                "FROM erp.itmu_tp_mfr AS t " +
