 ...
 */
public class SViewScaleItem extends erp.lib.table.STableTab {

    public SViewScaleItem(SClientInterface client, String tabTitle) {
        super(client, tabTitle, SDataConstants.ITMU_SCA_ITEM);
        initComponents();
    }
