...
public class SViewItem extends erp.lib.table.STableTab implements java.awt.event.ActionListener {
    ...
    private void initComponents() {
        ...
        STableColumn[] aoTableColumns = new STableColumn[37];
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT i.id_item, i.item, i.item_short, i.item_key, i.b_bulk, i.b_inv, i.b_lot, i.units_cont, " +
                "i.units_virt, i.prod_time, i.weight_gross, i.weight_delivery, i.surplus_per, i.b_free_price, i.b_free_disc, i.b_free_disc_u, " +
                "i.b_free_disc_ety, i.b_free_disc_doc, i.b_free_comms, i.b_del, i.ts_new, i.ts_edit, i.ts_del, " +
                "ig.igen, u.symbol, uc.symbol, uv.symbol, unc.symbol, uncu.symbol, tua.tp_unit, tl.tp_lev, brd.brd, " +
