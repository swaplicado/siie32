 ...
 */
public class SViewItemSupplier extends erp.lib.table.STableTab implements java.awt.event.ActionListener {

    private erp.lib.table.STabFilterDeleted moTabFilterDeleted;

    public SViewItemSupplier(erp.client.SClientInterface client, java.lang.String tabTitle) {
        super(client, tabTitle, SDataConstants.ITMU_ITEM_SUP);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        i = 0;
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "b.bp", "Proveedor", 250);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "bc.bp_key", "Clave proveedor", 100);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "i.item_key", "Clave insumo", STableConstants.WIDTH_ITEM_KEY);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "i.item", "Insumo", 400);
        aoTableColumns[i++] = new STableColumn(SLibConstants.DATA_TYPE_STRING, "ib.prod_line", "Línea producción", 200);
    ...
    public void createSqlQuery() {
        ...
        msSql = "SELECT ib.id_item, ib.id_bp, ib.prod_line, ib.b_del, "
