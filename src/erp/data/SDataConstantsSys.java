...
public abstract class SDataConstantsSys {
    ...
    public static final int FINS_CT_SYS_MOV_NA = 1;
    public static final int FINS_CT_SYS_MOV_ASSET = 2;
    public static final int FINS_CT_SYS_MOV_CASH = 3;
    public static final int FINS_CT_SYS_MOV_BPS = 4;
    public static final int FINS_CT_SYS_MOV_TAX = 5;
    public static final int FINS_CT_SYS_MOV_PUR = 6;
    public static final int FINS_CT_SYS_MOV_SAL = 7;
    public static final int FINS_CT_SYS_MOV_COGS = 8;
    public static final int FINS_CT_SYS_MOV_PROF = 9;
    ...
    public static final int FINX_ACC_PAY_PEND_ADV = 3;
