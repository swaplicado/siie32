...
public abstract class SDataConstantsSys {
    ...
    public static final int FINS_CT_SYS_MOV_NA = 1; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_ASSET = 2; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_CASH = 3; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_BPS = 4; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_TAX = 5; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_PUR = 6; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_SAL = 7; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_COGS = 8; // table fins_ct_sys_mov_xxx
    public static final int FINS_CT_SYS_MOV_PROF = 9; // table fins_ct_sys_mov_xxx

    public static final int[] FINS_TP_SYS_MOV_NA = new int[] { 1, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_ASSET_ASSET = new int[] { 2, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_ASSET_STOCK = new int[] { 2, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_CASH_CASH = new int[] { 3, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_CASH_BANK = new int[] { 3, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_BPS_CO = new int[] { 4, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_BPS_SUP = new int[] { 4, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_BPS_CUS = new int[] { 4, 3 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_BPS_CDR = new int[] { 4, 4 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_BPS_DBR = new int[] { 4, 5 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_DBT = new int[] { 5, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_DBT_PEND = new int[] { 5, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_DBT_PEND_ADV = new int[] { 5, 3 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_CDT = new int[] { 5, 11 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_CDT_PEND = new int[] { 5, 12 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_TAX_CDT_PEND_ADV = new int[] { 5, 13 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_PUR_ASSET = new int[] { 6, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_PUR_GOOD = new int[] { 6, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_PUR_SERV = new int[] { 6, 3 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_SAL_ASSET = new int[] { 7, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_SAL_GOOD = new int[] { 7, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_SAL_SERV = new int[] { 7, 3 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_COGS_ASSET = new int[] { 8, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_COGS_GOOD = new int[] { 8, 2 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_PROF_LOSS = new int[] { 9, 1 }; // table fins_tp_sys_mov_xxx
    public static final int[] FINS_TP_SYS_MOV_PROF_PROF = new int[] { 9, 2 }; // table fins_tp_sys_mov_xxx
